// ?sendDisconnectScreenOffCommand@BFMEConnectionManager@@QAEXH@Z
...
public:
	...
	void sendDisconnectScreenOffCommand(unsigned int frame);
...
void BFMEConnectionManager::sendDisconnectScreenOffCommand(unsigned int frame)
{
	m_disconnectManager->turnOffScreen(m_localSlot);
