...
// The caller and the BFME transition global identify this as the hot-key
// translator body. The transition call remains address-derived until its
// semantic name is recovered.
