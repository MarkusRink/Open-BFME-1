// ?update@WorkerAIUpdate@@UAE?AW4UpdateSleepTime@@XZ
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ??1WorkerAIUpdate@@MAE@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?getWarehouseScanDistance@WorkerAIUpdate@@UBEMXZ present-unmatched
...
UpdateSleepTime WorkerAIUpdate::update( void )
{
	...
	if( ( *reinterpret_cast<const UnsignedByte *>( reinterpret_cast<const char *>( *reinterpret_cast<Object **>( self + 0x0C ) ) + 0x344 ) & 1 ) != 0 )
		...
		*reinterpret_cast<const StateID *>( reinterpret_cast<const char *>( currentState ) + 0x04 ) == AS_DOZER )
	{
		...
		{
			ObjectID taskTarget = dozerInterface->getTaskTarget( currentTask );
		...
		reinterpret_cast<volatile BfmeWorkerUpdateMachine *>( reinterpret_cast<BfmeWorkerUpdateFields *>( self )->m_dozerMachine )->updateStateMachine();
	}
	else
	{
		reinterpret_cast<volatile BfmeWorkerUpdateMachine *>( reinterpret_cast<BfmeWorkerUpdateFields *>( self )->m_supplyMachine )->updateStateMachine();
	}
	return UPDATE_SLEEP_NONE;
} 
...
//-------------------------------------------------------------------------------------------------
// ?construct@WorkerAIUpdate@@ present-unmatched
...
/** We just exited from a supply truck task and are now idle, we should go back to Dozer idle
		mode */
// ------------------------------------------------------------------------------------------------
// ?exitingSupplyTruckState@WorkerAIUpdate@@UAEXXZ present-unmatched
...
//----------------------------------------------------------------------------------------
// ?privateDock@WorkerAIUpdate@@MAEXPAVObject@@W4CommandSourceType@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?privateRepair@WorkerAIUpdate@@MAEXPAVObject@@W4CommandSourceType@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?privateResumeConstruction@WorkerAIUpdate@@MAEXPAVObject@@W4CommandSourceType@@@Z present-unmatched
...
/** Cancel a task and reset the dozer behavior state machine so that it can 
	...
	* cancelled */
//-------------------------------------------------------------------------------------------------
// ?cancelTask@WorkerAIUpdate@@UAEXW4DozerTask@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?loseOneBox@WorkerAIUpdate@@UAE_NXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?resetSupplyTruckBrain@WorkerAIUpdate@@QAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?resetDozerBrain@WorkerAIUpdate@@QAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??1WorkerStateMachine@@MAE@XZ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@WorkerStateMachine@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@WorkerStateMachine@@MAEXPAVXfer@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?onExit@ActAsDozerState@@UAE?AW4StateReturnType@@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?onExit@ActAsSupplyTruckState@@UAE?AW4StateReturnType@@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?createBridgeScaffolding@WorkerAIUpdate@@UAEXPAVObject@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?removeBridgeScaffolding@WorkerAIUpdate@@UAEXPAVObject@@@Z present-unmatched
...
//------------------------------------------------------------------------------------------------
// ?startBuildingSound@WorkerAIUpdate@@UAEXPBVAudioEventRTS@@W4ObjectID@@@Z present-unmatched
...
//------------------------------------------------------------------------------------------------
// ?finishBuildingSound@WorkerAIUpdate@@UAEXXZ present-unmatched
...
//------------------------------------------------------------------------------------------------
// ?getUpgradedSupplyBoost@WorkerAIUpdate@@ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@WorkerAIUpdate@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@WorkerAIUpdate@@MAEXXZ present-unmatched
