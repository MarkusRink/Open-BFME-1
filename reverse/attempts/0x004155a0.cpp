...
// 113/113 B, 20 diff bytes: retail stores m_23c/m_319 before loading m_150; ours hoists the load (store/load reorder wall). Second loop is for(s=m_158; s; ++s){ if(!*s) break; ...}.
