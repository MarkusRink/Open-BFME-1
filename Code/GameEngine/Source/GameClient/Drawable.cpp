...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?killIcon@DrawableIconInfo@@QAEXW4DrawableIconType@@@Z present-unmatched
...
/*static*/ void Drawable::killStaticImages()
{
	...
	{
		delete [] s_animationTemplates;	// retail encodes ??_V, the array form
...
//-------------------------------------------------------------------------------------------------
// ??0Drawable@@QAE@PBVThingTemplate@@W4DrawableStatus@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ??1Drawable@@MAE@XZ present-unmatched
Drawable::~Drawable()
{
	Int i;
...
//-------------------------------------------------------------------------------------------------
// ?onDestroy@Drawable@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isVisible@Drawable@@QAE_NXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getShouldAnimate@Drawable@@QBE_N_N@Z present-unmatched
...
// ?clientOnly_getFirstRenderObjInfo@Drawable@@QAE_NPAUCoord3D@@PAMPAVMatrix3D@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setAnimationLoopDuration@Drawable@@QAEXI@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setAnimationCompletionTime@Drawable@@QAEXI@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setAnimationFrame@Drawable@@UAEXH@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?updateSubObjects@Drawable@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?showSubObject@Drawable@@QAEXABVAsciiString@@_N@Z present-unmatched
...
*/
// ?getAnimationScrubScalar@Drawable@@ present-unmatched
...
// ?releaseShadows@Drawable@@QAEXXZ present-unmatched
...
// ?allocateShadows@Drawable@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setFullyObscuredByShroud@Drawable@@QAEX_N@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?colorTint@Drawable@@QAEXPBURGBColor@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?onSelected@Drawable@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?onUnselected@Drawable@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getTintColor@Drawable@@QBEPBVVector3@@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getSelectionColor@Drawable@@QBEPBVVector3@@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?fadeOut@Drawable@@QAEXI@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?fadeIn@Drawable@@QAEXI@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?reactToBodyDamageStateChange@Drawable@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setEffectiveOpacity@Drawable@@QAEXMM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?imitateStealthLook@Drawable@@QAEXAAV1@@Z present-unmatched
...
// ?updateDrawable@Drawable@@QAEXXZ present-unmatched
...
// ?onLevelStart@Drawable@@QAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?calcPhysicsXformThrust@Drawable@@IAEXPBVLocomotor@@AAUPhysicsXformInfo@1@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?calcPhysicsXformMotorcycle@Drawable@@IAEXPBVLocomotor@@AAUPhysicsXformInfo@1@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getAmbientSoundByDamage@Drawable@@IAEABVAudioEventRTS@@W4BodyDamageType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
#ifdef _DEBUG
// ?validatePos@Drawable@@ present-unmatched
...
//=============================================================================
// ?setStealthLook@Drawable@@QAEXW4StealthLookType@@@Z present-unmatched
...
// ?drawsAnyUIText@Drawable@@AAE_NXZ present-unmatched
...
//------------------------------------------------------------------------------------------------
// ?clearEmoticon@Drawable@@QAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?drawAmmo@Drawable@@AAEXPBUIRegion2D@@@Z present-unmatched
...
// Body in Drawable_drawUIText.asm (exact 509B retail).

// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?drawHealing@Drawable@@AAEXPBUIRegion2D@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?drawDemoralized@Drawable@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?drawBombed@Drawable@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?drawDisabled@Drawable@@AAEXPBUIRegion2D@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?drawConstructPercent@Drawable@@AAEXPBUIRegion2D@@@Z present-unmatched
...
/** Draw caption */
//-------------------------------------------------------------------------------------------------
// ?drawCaption@Drawable@@AAEXPBUIRegion2D@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?drawVeterancy@Drawable@@AAEXPBUIRegion2D@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?drawHealthBar@Drawable@@AAEXPBUIRegion2D@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getDrawModules@Drawable@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?replaceModelConditionFlags@Drawable@@QAEXABV?$BitFlags@$0HF@@@_N@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setIndicatorColor@Drawable@@QAEXH@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?getDrawableGeometryInfo@Drawable@@QBEABVGeometryInfo@@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?reactToTransformChange@Drawable@@MAEXPBVMatrix3D@@PBUCoord3D@@M@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?reactToGeometryChange@Drawable@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setInstanceMatrix@Drawable@@QAEXPBVMatrix3D@@@Z present-unmatched
 ...
 */
//-------------------------------------------------------------------------------------------------
// ?getTransformMatrix@Drawable@@QBEPBVMatrix3D@@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getCaptionText@Drawable@@QAE?AVUnicodeString@@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setTimeOfDay@Drawable@@QAEXW4TimeOfDay@@@Z present-unmatched
 ...
 */
// ?getBaseSoundAmbientInfo@Drawable@@QBEPBUAudioEventInfo@@XZ present-unmatched
 ...
 */
// ?setCustomSoundAmbientOff@Drawable@@QAEXXZ present-unmatched
 ...
 */
// ?setCustomSoundAmbientInfo@Drawable@@QAEXPAVDynamicAudioEventInfo@@@Z present-unmatched
 ...
 */
// ?clearCustomSoundAmbient@Drawable@@IAEX_N@Z present-unmatched
...
/** Attach and start playing an ambient sound to this drawable */
//-------------------------------------------------------------------------------------------------
// ?startAmbientSound@Drawable@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?stopAmbientSound@Drawable@@QAEXXZ present-unmatched
...
// ?enableAmbientSound@Drawable@@QAEX_N@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?updateHiddenStatus@Drawable@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?updateDrawableClipStatus@Drawable@@QAEXIIW4WeaponSlotType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?notifyDrawableDependencyCleared@Drawable@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isSelectable@Drawable@@QBE_NXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?preloadAssets@Drawable@@QAEXW4TimeOfDay@@@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@Drawable@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
  ...
  * 7: Save the customize ambient sound info
	*/
// ------------------------------------------------------------------------------------------------
// ?xfer@Drawable@@MAEXPAVXfer@@@Z present-unmatched
...
//=================================================================================================
//=================================================================================================
// ??0TintEnvelope@@QAE@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?update@TintEnvelope@@QAEXXZ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@TintEnvelope@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@TintEnvelope@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load Post Process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@TintEnvelope@@MAEXXZ present-unmatched
