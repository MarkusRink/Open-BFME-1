// ?rva005536F0@BfmeAptScreenOnlineLogin@@QAEXPBD@Z
//
...
// stlport
//
// Neutral identity for the 315-byte OnlineLogin boolean-state writer.  Retail
// 0x005538A0 registers 0x00553520 as AptOnline::Login::Login through ILT
// 0x0000649C; it does not register this body.  The typed owner and receiver
// layout are nevertheless fixed by the sibling OnlineLogin methods, the
// TheBfmeOnlineLogin load, and the shared 0x00049E1D bool tail route.
...
{
public:
	void rva005536F0( const char *argument );
...
void BfmeAptScreenOnlineLogin::rva005536F0( const char * )
{
	if( TheBfmeOnlineLogin != 0 )
	{
		...
		{
			TheBfmeOnlineLogin->rva00552C40( true );
			return;
		}
