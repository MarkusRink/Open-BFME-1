...
// TU's pooled class is pulled in under the override and nothing else.
...
//------------------------------------------------------------------------------ INI::parseMiscEvaData
// BFME adds a "MiscEvaData" block that Zero Hour has no equivalent for: one
// global bundle of Eva settings, stored inside Eva itself at +0x60 rather than
// in a registry keyed by name. Unlike EvaEvent it refuses to be overridden from
// a map.ini, which is what the load-type guard is.
class MiscEvaData
{
public:
...
void INI::parseMiscEvaData( INI* ini )
{
	...
	{
		char m_pad[ 0x60 ];
		MiscEvaData m_miscEvaData;
	};
	ini->initFromINI( &reinterpret_cast<RetailEva *>( TheEva )->m_miscEvaData,
										MiscEvaData::m_fieldParseTable );
}

//------------------------------------------------------------------------------ INI::parseEvaEvent
// ?parseEvaEvent@INI@@ present-unmatched
...
//------------------------------------------------------------------------------------ EvaCheckInfo
// ??0EvaCheckInfo@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?nameToMessage@Eva@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?messageToName@Eva@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?newEvaCheckInfo@Eva@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getEvaCheckInfo@Eva@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setShouldPlay@Eva@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isTimeForCheck@Eva@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?messageShouldPlay@Eva@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?shouldPlayLowPower@Eva@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?shouldPlayGenericHandler@Eva@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?playMessage@Eva@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?processPlayingMessages@Eva@@ present-unmatched
