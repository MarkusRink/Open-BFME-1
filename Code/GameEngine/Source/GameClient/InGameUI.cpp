...
/** A command would be given if a click were to happen, so give a preview hint of what it would be.
	...
	*/
// ?createCommandHint@InGameUI@@UAEXPBVGameMessage@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?selectAllUnitsByTypeAcrossMap@InGameUI@@UAEHV?$BitFlags@$0HE@@@0@Z matched 756 bytes (Open-BFME5)
__declspec(naked) Int InGameUI::selectAllUnitsByTypeAcrossMap(KindOfMaskType, KindOfMaskType)
{
	__asm
	{
		__emit 0x64;
