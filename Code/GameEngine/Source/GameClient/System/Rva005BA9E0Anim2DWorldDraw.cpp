...
class Rva005BA9E0Snapshot
{
protected:
	void *m_vtable;
};

class Rva005BA9E0Anim2D : public Rva005BA9E0Snapshot
{
public:
...
void Rva005BA9E0Anim2D::draw(Int x, Int y, Int width, Int height)
{
	...
	drawImage(TheDisplay, image, (Real)x, (Real)y,
		(Real)(x + width), (Real)(y + height), color, 2);
