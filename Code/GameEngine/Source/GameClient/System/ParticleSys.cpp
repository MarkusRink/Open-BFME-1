// cl: /DNDEBUG /DWIN32 /D_WINDOWS /MD /EHsc /DBFME_STLP_NODE_ALLOC /Ireference/shims/campaignmanagerascii /Ireference/shims/stlp_nodealloc /Ireference/shims/sweep /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Include /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Include /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/Compression /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngineDevice/Include /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Main /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WWLib /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WW3D2 /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WWMath /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WWDebug /Ireference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WWSaveLoad /ICode/Libraries/Source/WWVegas/WWLib
// stlport
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??0ParticleInfo@@ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@ParticleInfo@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@ParticleInfo@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@ParticleInfo@@MAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?computeAlphaRate@Particle@@IAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?computeColorRate@Particle@@IAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ??0Particle@@QAE@PAVParticleSystem@@PBVParticleInfo@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?applyForce@Particle@@QAEXPBUCoord3D@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?update@Particle@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?doWindMotion@Particle@@QAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?getPriority@Particle@@QAE?AW4ParticlePriorityType@@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?isInvisible@Particle@@QAE_NXZ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@Particle@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@Particle@@MAEXPAVXfer@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??0ParticleSystemInfo@@QAE@XZ present-unmatched
...
// ?tintAllColors@ParticleSystemInfo@@QAEXH@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@ParticleSystemInfo@@UAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@ParticleSystemInfo@@UAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@ParticleSystemInfo@@UAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
/** Construct particle system from template (3-arg). */
// ------------------------------------------------------------------------------------------------
// ??0ParticleSystem@@QAE@PBVParticleSystemTemplate@@W4ParticleSystemID@@_N@Z
// Body in ParticleSys_ParticleSystem_ctor.asm (exact 1426B retail @ 0x5CF850).
// BFME sizeof 0x1E0; factory at 0x5C33E0 (new 0x1E0 + thiscall). Queue 0x6E2296 was helper epilogue.
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?setMaster@ParticleSystem@@QAEXPAV1@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?setSlave@ParticleSystem@@QAEXPAV1@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?setPosition@ParticleSystem@@QAEXPBUCoord3D@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?computePointOnUnitSphere@ParticleSystem@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?computeParticleVelocity@ParticleSystem@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?computeParticlePosition@ParticleSystem@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?createParticle@ParticleSystem@@MAEPAVParticle@@PBVParticleInfo@@W4ParticlePriorityType@@_N@Z present-unmatched
...
// Body in ParticleSys_generateParticleInfo.asm (exact 1257B retail).
...
// ------------------------------------------------------------------------------------------------
// ?updateWindMotion@ParticleSystem@@QAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?addParticle@ParticleSystem@@QAEXPAVParticle@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?removeParticle@ParticleSystem@@QAEXPAVParticle@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?mergeRelatedParticleSystems@ParticleSystem@@SA?AVParticleInfo@@PAV1@0_N@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?setLifetimeRange@ParticleSystem@@QAEXMM@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@ParticleSystem@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@ParticleSystem@@MAEXPAVXfer@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?parseRandomRGBColor@ParticleSystemTemplate@@SAXPAVINI@@PAX1PBX@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??0ParticleSystemTemplate@@QAE@ABVAsciiString@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??1ParticleSystemTemplate@@MAE@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?createSlaveSystem@ParticleSystemTemplate@@QBEPAVParticleSystem@@_N@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??0ParticleSystemManager@@QAE@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??1ParticleSystemManager@@UAE@XZ present-unmatched
...
// ?update@ParticleSystemManager@@UAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?createParticleSystem@ParticleSystemManager@@QAEPAVParticleSystem@@PBVParticleSystemTemplate@@_N@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?createAttachedParticleSystemID@ParticleSystemManager@@QAE?AW4ParticleSystemID@@PBVParticleSystemTemplate@@PAVObject@@_N@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?findParticleSystem@ParticleSystemManager@@QAEPAVParticleSystem@@W4ParticleSystemID@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?newTemplate@ParticleSystemManager@@QAEPAVParticleSystemTemplate@@ABVAsciiString@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?findParentTemplate@ParticleSystemManager@@QBEPAVParticleSystemTemplate@@ABVAsciiString@@H@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?destroyAttachedSystems@ParticleSystemManager@@QAEXPAVObject@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?addParticle@ParticleSystemManager@@QAEXPAVParticle@@W4ParticlePriorityType@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?removeParticle@ParticleSystemManager@@QAEXPAVParticle@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?preloadAssets@ParticleSystemManager@@UAEXW4TimeOfDay@@@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@ParticleSystemManager@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@ParticleSystemManager@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@ParticleSystemManager@@MAEXXZ present-unmatched
