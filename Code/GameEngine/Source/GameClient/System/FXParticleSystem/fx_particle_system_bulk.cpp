...
class DefaultModule0Allocation {
public:
...
class DefaultModule6Allocation {
public:
...
class DefaultModule7Allocation {
public:
...
class CylindricalEmissionVelocityTemplateParseShim {
public:
    void parse(INI *ini);
};

class CylindricalEmissionVelocityTemplateAllocation {
public:
...
class OutwardEmissionVelocityTemplateParseShim {
public:
    void parse(INI *ini);
};

class OutwardEmissionVelocityTemplateAllocation
    : public ConcreteModuleTemplate<ModuleTag<4, OUTWARD_EMISSION_VELOCITY_MODULE_KEY, OUTWARD_EMISSION_VELOCITY_MODULE_NAME, OutwardEmissionVelocityModule, OutwardEmissionVelocityModuleTemplate, DefaultParticleModule<4>, DefaultParticleModuleTemplate<4> > > {
private:
    unsigned char m_storage[0x24];
};
...
class HemisphericalEmissionVelocityTemplateParseShim {
public:
    void parse(INI *ini);
};

class HemisphericalEmissionVelocityTemplateAllocation {
public:
...
class SphereEmissionVolumeTemplateParseShim {
public:
    void parse(INI *ini);
};

class SphereEmissionVolumeTemplateAllocation {
public:
...
class SphericalEmissionVelocityTemplateParseShim {
public:
    void parse(INI *ini);
};

class SphericalEmissionVelocityTemplateAllocation {
public:
...
class LightningEmissionTemplateAllocation {
public:
...
class LightningDrawTemplateParseShim {
public:
    void parse(INI *ini);
};

template <>
class DefaultParticleModuleTemplate<6> : public LightningDrawModuleTemplate {
};
...
class RDM_Iface1 { public: virtual void slot(); };
class RDM_Iface2 { public: virtual void slot(); };
class RenderObjectDrawModule : public RDM_Primary, public RDM_Iface1, public RDM_Iface2
{
public:
    RenderObjectDrawModule(TrackingPtr<ParticleSystem> &sys, const void *source);
...
template <int Category>
class DefaultParticleModule : public RenderObjectDrawModule
{
public:
    DefaultParticleModule(TrackingPtr<ParticleSystem> &sys, const void *source)
        : RenderObjectDrawModule(sys, source) {}
};
...
class ButterflyDrawTemplateAllocation {
public:
...
class ButterflyDrawTemplateParseShim {
public:
    void parse(INI *ini);
};

class ButterflyDrawModuleCtorShim {
public:
    void construct(TrackingPtr<ParticleSystem> &sys, const void *source);
};

class ButterflyDrawModuleAllocation {
public:
...
class LightningDrawTemplateAllocation {
public:
...
class LightningDrawModuleCtorShim {
public:
    void construct(TrackingPtr<ParticleSystem> &sys, const void *source);
};

class LightningDrawModuleAllocation {
public:
...
class QuadDrawTemplateParseShim {
public:
    void parse(INI *ini);
};

class QuadDrawTemplateAllocation {
public:
...
class QuadDrawModuleCtorShim {
public:
    void construct(TrackingPtr<ParticleSystem> &sys, const void *source);
};

class QuadDrawModuleAllocation {
public:
...
class RenderObjectDrawTemplateParseShim {
public:
    void parse(INI *ini);
};
...
class StreakDrawTemplateAllocation {
public:
...
class LifeEventTemplateParseShim {
public:
    void parse(INI *ini);
};
...
class LifeEventModuleCtorShim {
public:
    void construct(TrackingPtr<ParticleSystem> &sys, const void *source);
};

class LifeEventModuleAllocation {
public:
...
class TerrainCollisionModuleCtorShim {
public:
    void construct(TrackingPtr<ParticleSystem> &sys, const void *source);
};

class TerrainCollisionModuleAllocation {
public:
...
class OrthoEmissionVelocityTemplateParseShim {
public:
    void parse(INI *ini);
};

class OrthoEmissionVelocityTemplateAllocation {
public:
...
class RenderObjectUpdateTemplateParseShim {
public:
    void parse(INI *ini);
};

// Open-BFME5: createTemplate(INI*) allocates the 0xA0-byte particle-template
// object, constructs its RenderObjectUpdateModuleTemplate subobject, and then
// installs the particle-template vtables over the three retail subobjects.
class RenderObjectParticleUpdateModuleTemplateAllocation {
public:
...
// The named data-bearing definition lives in
// DefaultModuleTag0ConcreteModuleClassGetInstance.cpp; the constructor and destructor
// above remain here as independently matched bulk-TU members.
...
// The named data-bearing definition lives in
// DefaultModuleTag1ConcreteModuleClassGetInstance.cpp; the constructor and destructor
// above remain here as independently matched bulk-TU members.
...
// The named data-bearing definition lives in
// DefaultModuleTag2ConcreteModuleClassGetInstance.cpp; the constructor and destructor
// above remain here as independently matched bulk-TU members.
...
// The named data-bearing definition lives in
// DefaultModuleTag3ConcreteModuleClassGetInstance.cpp; the constructor and destructor
// above remain here as independently matched bulk-TU members.
...
// The named data-bearing definition lives in
// DefaultModuleTag6ConcreteModuleClassGetInstance.cpp; the constructor and destructor
// above remain here as independently matched bulk-TU members.
...
// The named data-bearing definition lives in
// DefaultModuleTag7ConcreteModuleClassGetInstance.cpp; the constructor and destructor
// above remain here as independently matched bulk-TU members.
...
RenderObjectUpdateModuleTemplate *ConcreteModuleClass<ModuleTag<2, RENDEROBJECT_UPDATE_MODULE_KEY, RENDEROBJECT_UPDATE_MODULE_NAME, RenderObjectUpdateModule, RenderObjectUpdateModuleTemplate, RenderObjectParticleUpdateModule, RenderObjectParticleUpdateModuleTemplate> >::createTemplate(INI *ini) const
{
    std::auto_ptr<RenderObjectUpdateModuleTemplate> moduleTemplate(
        (RenderObjectUpdateModuleTemplate *)new RenderObjectParticleUpdateModuleTemplateAllocation);
    ((RenderObjectUpdateTemplateParseShim *)moduleTemplate.get())->parse(ini);
...
{
    return (RenderObjectUpdateModuleTemplate *)new RenderObjectParticleUpdateModuleTemplateAllocation;
}
...
// The named data-bearing definition lives in
// RenderObjectUpdateConcreteModuleClassGetInstance.cpp; the constructor and
// destructor above remain here as independently matched bulk-TU members.
...
{
    std::auto_ptr<CylindricalEmissionVelocityModuleTemplate> moduleTemplate(
        (CylindricalEmissionVelocityModuleTemplate *)new CylindricalEmissionVelocityTemplateAllocation);
    ((CylindricalEmissionVelocityTemplateParseShim *)moduleTemplate.get())->parse(ini);
    return moduleTemplate.release();
}
...
{
    return (CylindricalEmissionVelocityModuleTemplate *)new CylindricalEmissionVelocityTemplateAllocation;
}
...
// The named data-bearing definition lives in
// CylindricalEmissionVelocityConcreteModuleClassGetInstance.cpp; the
// constructor and destructor above remain here as independently matched
// bulk-TU members.
...
HemisphericalEmissionVelocityModuleTemplate *ConcreteModuleClass<ModuleTag<4, HEMISPHERICAL_EMISSION_VELOCITY_MODULE_KEY, HEMISPHERICAL_EMISSION_VELOCITY_MODULE_NAME, HemisphericalEmissionVelocityModule, HemisphericalEmissionVelocityModuleTemplate, DefaultParticleModule<4>, DefaultParticleModuleTemplate<4> > >::createTemplate(INI *ini) const
{
    std::auto_ptr<HemisphericalEmissionVelocityModuleTemplate> moduleTemplate(
        (HemisphericalEmissionVelocityModuleTemplate *)new HemisphericalEmissionVelocityTemplateAllocation);
    ((HemisphericalEmissionVelocityTemplateParseShim *)moduleTemplate.get())->parse(ini);
    return moduleTemplate.release();
}
...
HemisphericalEmissionVelocityModuleTemplate *ConcreteModuleClass<ModuleTag<4, HEMISPHERICAL_EMISSION_VELOCITY_MODULE_KEY, HEMISPHERICAL_EMISSION_VELOCITY_MODULE_NAME, HemisphericalEmissionVelocityModule, HemisphericalEmissionVelocityModuleTemplate, DefaultParticleModule<4>, DefaultParticleModuleTemplate<4> > >::createTemplate() const
{
    return (HemisphericalEmissionVelocityModuleTemplate *)new HemisphericalEmissionVelocityTemplateAllocation;
}
...
// The named data-bearing definition lives in
// HemisphericalEmissionVelocityConcreteModuleClassGetInstance.cpp; the
// constructor and destructor above remain here as independently matched
// bulk-TU members.
...
OutwardEmissionVelocityModuleTemplate *ConcreteModuleClass<ModuleTag<4, OUTWARD_EMISSION_VELOCITY_MODULE_KEY, OUTWARD_EMISSION_VELOCITY_MODULE_NAME, OutwardEmissionVelocityModule, OutwardEmissionVelocityModuleTemplate, DefaultParticleModule<4>, DefaultParticleModuleTemplate<4> > >::createTemplate(INI *ini) const
{
    std::auto_ptr<OutwardEmissionVelocityModuleTemplate> moduleTemplate(
        (OutwardEmissionVelocityModuleTemplate *)new OutwardEmissionVelocityTemplateAllocation);
    ((OutwardEmissionVelocityTemplateParseShim *)moduleTemplate.get())->parse(ini);
    return moduleTemplate.release();
}

// ?createTemplate@?$ConcreteModuleClass@V?$ModuleTag@$03$E?OUTWARD_EMISSION_VELOCITY_MODULE_KEY@FXParticleSystem@@3QBDB$E?OUTWARD_EMISSION_VELOCITY_MODULE_NAME@2@3QBDBVOutwardEmissionVelocityModule@2@VOutwardEmissionVelocityModuleTemplate@2@V?$DefaultParticleModule@$03@2@V?$DefaultParticleModuleTemplate@$03@2@@FXParticleSystem@@@FXParticleSystem@@UBEPAVOutwardEmissionVelocityModuleTemplate@2@XZ
OutwardEmissionVelocityModuleTemplate *ConcreteModuleClass<ModuleTag<4, OUTWARD_EMISSION_VELOCITY_MODULE_KEY, OUTWARD_EMISSION_VELOCITY_MODULE_NAME, OutwardEmissionVelocityModule, OutwardEmissionVelocityModuleTemplate, DefaultParticleModule<4>, DefaultParticleModuleTemplate<4> > >::createTemplate() const
{
    return (OutwardEmissionVelocityModuleTemplate *)new OutwardEmissionVelocityTemplateAllocation;
}
...
// The named data-bearing definition lives in
// OutwardEmissionVelocityConcreteModuleClassGetInstance.cpp; the
// constructor and destructor above remain here as independently matched
// bulk-TU members.
...
SphericalEmissionVelocityModuleTemplate *ConcreteModuleClass<ModuleTag<4, SPHERICAL_EMISSION_VELOCITY_MODULE_KEY, SPHERICAL_EMISSION_VELOCITY_MODULE_NAME, SphericalEmissionVelocityModule, SphericalEmissionVelocityModuleTemplate, DefaultParticleModule<4>, DefaultParticleModuleTemplate<4> > >::createTemplate(INI *ini) const
{
    std::auto_ptr<SphericalEmissionVelocityModuleTemplate> moduleTemplate(
        (SphericalEmissionVelocityModuleTemplate *)new SphericalEmissionVelocityTemplateAllocation);
    ((SphericalEmissionVelocityTemplateParseShim *)moduleTemplate.get())->parse(ini);
    return moduleTemplate.release();
}
...
SphericalEmissionVelocityModuleTemplate *ConcreteModuleClass<ModuleTag<4, SPHERICAL_EMISSION_VELOCITY_MODULE_KEY, SPHERICAL_EMISSION_VELOCITY_MODULE_NAME, SphericalEmissionVelocityModule, SphericalEmissionVelocityModuleTemplate, DefaultParticleModule<4>, DefaultParticleModuleTemplate<4> > >::createTemplate() const
{
    return (SphericalEmissionVelocityModuleTemplate *)new SphericalEmissionVelocityTemplateAllocation;
}
...
// The named data-bearing definition lives in
// SphericalEmissionVelocityConcreteModuleClassGetInstance.cpp; the
// constructor and destructor above remain here as independently matched
// bulk-TU members.
...
// The named data-bearing definition lives in
// BoxEmissionVolumeConcreteModuleClassGetInstance.cpp; the constructor and
// destructor above remain here as independently matched bulk-TU members.
...
// The named data-bearing definition lives in
// CylinderEmissionVolumeConcreteModuleClassGetInstance.cpp; the constructor
// and destructor above remain here as independently matched bulk-TU members.
...
LightningEmissionModuleTemplate *ConcreteModuleClass<ModuleTag<5, LIGHTNING_EMISSION_MODULE_KEY, LIGHTNING_EMISSION_MODULE_NAME, LightningEmissionModule, LightningEmissionModuleTemplate, DefaultParticleModule<5>, DefaultParticleModuleTemplate<5> > >::createTemplate() const
{
    return (LightningEmissionModuleTemplate *)new LightningEmissionTemplateAllocation;
}
...
// The named data-bearing definition lives in
// LightningEmissionConcreteModuleClassGetInstance.cpp; the constructor and
// destructor above remain here as independently matched bulk-TU members.
...
// The named data-bearing definition lives in
// LineEmissionVolumeConcreteModuleClassGetInstance.cpp; the constructor and
// destructor above remain here as independently matched bulk-TU members.
...
SphereEmissionVolumeModuleTemplate *ConcreteModuleClass<ModuleTag<5, SPHERE_EMISSION_VOLUME_MODULE_KEY, SPHERE_EMISSION_VOLUME_MODULE_NAME, SphereEmissionVolumeModule, SphereEmissionVolumeModuleTemplate, DefaultParticleModule<5>, DefaultParticleModuleTemplate<5> > >::createTemplate(INI *ini) const
{
    std::auto_ptr<SphereEmissionVolumeModuleTemplate> moduleTemplate(
        (SphereEmissionVolumeModuleTemplate *)new SphereEmissionVolumeTemplateAllocation);
    ((SphereEmissionVolumeTemplateParseShim *)moduleTemplate.get())->parse(ini);
    return moduleTemplate.release();
}
...
// The named data-bearing definition lives in
// SphereEmissionVolumeConcreteModuleClassGetInstance.cpp; the constructor
// and destructor above remain here as independently matched bulk-TU members.
...
ButterflyDrawModuleTemplate *ConcreteModuleClass<ModuleTag<6, BUTTERFLY_DRAW_MODULE_KEY, BUTTERFLY_DRAW_MODULE_NAME, ButterflyDrawModule, ButterflyDrawModuleTemplate, DefaultParticleModule<6>, DefaultParticleModuleTemplate<6> > >::createTemplate(INI *ini) const
{
    std::auto_ptr<ButterflyDrawModuleTemplate> moduleTemplate(
        (ButterflyDrawModuleTemplate *)new ButterflyDrawTemplateAllocation);
    ((ButterflyDrawTemplateParseShim *)moduleTemplate.get())->parse(ini);
    return moduleTemplate.release();
}

// ?createTemplate@?$ConcreteModuleClass@V?$ModuleTag@$05$E?BUTTERFLY_DRAW_MODULE_KEY@FXParticleSystem@@3QBDB$E?BUTTERFLY_DRAW_MODULE_NAME@2@3QBDBVButterflyDrawModule@2@VButterflyDrawModuleTemplate@2@V?$DefaultParticleModule@$05@2@V?$DefaultParticleModuleTemplate@$05@2@@FXParticleSystem@@@FXParticleSystem@@UBEPAVButterflyDrawModuleTemplate@2@XZ
ButterflyDrawModuleTemplate *ConcreteModuleClass<ModuleTag<6, BUTTERFLY_DRAW_MODULE_KEY, BUTTERFLY_DRAW_MODULE_NAME, ButterflyDrawModule, ButterflyDrawModuleTemplate, DefaultParticleModule<6>, DefaultParticleModuleTemplate<6> > >::createTemplate() const
{
    return (ButterflyDrawModuleTemplate *)new ButterflyDrawTemplateAllocation;
}
...
// The named data-bearing definition lives in
// ButterflyDrawConcreteModuleClassGetInstance.cpp; the constructor and
// destructor above remain here as independently matched bulk-TU members.
...
LightningDrawModuleTemplate *ConcreteModuleClass<ModuleTag<6, LIGHTNING_DRAW_MODULE_KEY, LIGHTNING_DRAW_MODULE_NAME, LightningDrawModule, LightningDrawModuleTemplate, DefaultParticleModule<6>, DefaultParticleModuleTemplate<6> > >::createTemplate(INI *ini) const
{
    std::auto_ptr<LightningDrawModuleTemplate> moduleTemplate(new DefaultParticleModuleTemplate<6>);
    ((LightningDrawTemplateParseShim *)moduleTemplate.get())->parse(ini);
    return moduleTemplate.release();
}

// ?createTemplate@?$ConcreteModuleClass@V?$ModuleTag@$05$E?LIGHTNING_DRAW_MODULE_KEY@FXParticleSystem@@3QBDB$E?LIGHTNING_DRAW_MODULE_NAME@2@3QBDBVLightningDrawModule@2@VLightningDrawModuleTemplate@2@V?$DefaultParticleModule@$05@2@V?$DefaultParticleModuleTemplate@$05@2@@FXParticleSystem@@@FXParticleSystem@@UBEPAVLightningDrawModuleTemplate@2@XZ
LightningDrawModuleTemplate *ConcreteModuleClass<ModuleTag<6, LIGHTNING_DRAW_MODULE_KEY, LIGHTNING_DRAW_MODULE_NAME, LightningDrawModule, LightningDrawModuleTemplate, DefaultParticleModule<6>, DefaultParticleModuleTemplate<6> > >::createTemplate() const
{
    return (LightningDrawModuleTemplate *)new LightningDrawTemplateAllocation;
}
...
// The named data-bearing definition lives in
// LightningDrawConcreteModuleClassGetInstance.cpp; the constructor and
// destructor above remain here as independently matched bulk-TU members.
...
QuadDrawModuleTemplate *ConcreteModuleClass<ModuleTag<6, QUAD_DRAW_MODULE_KEY, QUAD_DRAW_MODULE_NAME, QuadDrawModule, QuadDrawModuleTemplate, DefaultParticleModule<6>, DefaultParticleModuleTemplate<6> > >::createTemplate(INI *ini) const
{
    std::auto_ptr<QuadDrawModuleTemplate> moduleTemplate(
        (QuadDrawModuleTemplate *)new QuadDrawTemplateAllocation);
    ((QuadDrawTemplateParseShim *)moduleTemplate.get())->parse(ini);
    return moduleTemplate.release();
}
...
{
    return (QuadDrawModuleTemplate *)new QuadDrawTemplateAllocation;
}
...
// The named data-bearing definition lives in
// QuadDrawConcreteModuleClassGetInstance.cpp; the constructor and destructor
// above remain here as independently matched bulk-TU members.
...
RenderObjectDrawModuleTemplate *ConcreteModuleClass<ModuleTag<6, RENDEROBJECT_DRAW_MODULE_KEY, RENDEROBJECT_DRAW_MODULE_NAME, RenderObjectDrawModule, RenderObjectDrawModuleTemplate, DefaultParticleModule<6>, DefaultParticleModuleTemplate<6> > >::createTemplate(INI *ini) const
{
    std::auto_ptr<RenderObjectDrawModuleTemplate> moduleTemplate(
        (RenderObjectDrawModuleTemplate *)new RenderObjectDrawTemplateAllocation);
    ((RenderObjectDrawTemplateParseShim *)moduleTemplate.get())->parse(ini);
    return moduleTemplate.release();
}
...
{
    return (RenderObjectDrawModuleTemplate *)new RenderObjectDrawTemplateAllocation;
}
...
// The named data-bearing definition lives in
// RenderObjectDrawConcreteModuleClassGetInstance.cpp; the constructor and
// destructor above remain here as independently matched bulk-TU members.
...
{
    return (StreakDrawModuleTemplate *)new StreakDrawTemplateAllocation;
}
...
// The named data-bearing definition lives in
// StreakDrawConcreteModuleClassGetInstance.cpp; the constructor and destructor
// above remain here as independently matched bulk-TU members.
...
LifeEventModuleTemplate *ConcreteModuleClass<ModuleTag<8, LIFE_EVENT_MODULE_KEY, LIFE_EVENT_MODULE_NAME, LifeEventModule, LifeEventModuleTemplate, ParticleLifeEventModule, ParticleLifeEventModuleTemplate> >::createTemplate(INI *ini) const
{
    std::auto_ptr<LifeEventModuleTemplate> moduleTemplate(
        (LifeEventModuleTemplate *)new ParticleLifeEventModuleTemplate);
    ((LifeEventTemplateParseShim *)moduleTemplate.get())->parse(ini);
    return moduleTemplate.release();
}
...
// The named data-bearing definition lives in
// LifeEventConcreteModuleClassGetInstance.cpp; the constructor and
// destructor above remain here as independently matched bulk-TU members.
...
// ?createTemplate@?$ConcreteModuleClass@V?$ModuleTag@$07$E?TERRAIN_COLLISION_MODULE_KEY@FXParticleSystem@@3QBDB$E?TERRAIN_COLLISION_MODULE_NAME@2@3QBDBVTerrainCollisionModule@2@VTerrainCollisionModuleTemplate@2@VParticleTerrainCollisionModule@2@VParticleTerrainCollisionModuleTemplate@2@@FXParticleSystem@@@FXParticleSystem@@UBEPAVTerrainCollisionModuleTemplate@2@XZ
TerrainCollisionModuleTemplate *ConcreteModuleClass<ModuleTag<8, TERRAIN_COLLISION_MODULE_KEY, TERRAIN_COLLISION_MODULE_NAME, TerrainCollisionModule, TerrainCollisionModuleTemplate, ParticleTerrainCollisionModule, ParticleTerrainCollisionModuleTemplate> >::createTemplate() const
{
    return (TerrainCollisionModuleTemplate *)new TerrainCollisionTemplateAllocation;
}
...
// The named data-bearing definition lives in
// TerrainCollisionConcreteModuleClassGetInstance.cpp; the constructor and
// destructor above remain here as independently matched bulk-TU members.
...
OrthoEmissionVelocityModuleTemplate *ConcreteModuleClass<OrthoEmissionVelocityModuleTag>::createTemplate(INI *ini) const
{
    std::auto_ptr<OrthoEmissionVelocityModuleTemplate> moduleTemplate(
        (OrthoEmissionVelocityModuleTemplate *)new OrthoEmissionVelocityTemplateAllocation);
    ((OrthoEmissionVelocityTemplateParseShim *)moduleTemplate.get())->parse(ini);
    return moduleTemplate.release();
}
...
OrthoEmissionVelocityModuleTemplate *ConcreteModuleClass<OrthoEmissionVelocityModuleTag>::createTemplate() const
{
    return (OrthoEmissionVelocityModuleTemplate *)new OrthoEmissionVelocityTemplateAllocation;
}
...
// The named data-bearing definition lives in
// OrthoEmissionVelocityConcreteModuleClassGetInstance.cpp; the constructor and destructor
// above remain here as independently matched bulk-TU members.
...
// The named data-bearing definition lives in
// PointEmissionVolumeConcreteModuleClassGetInstance.cpp; the constructor and destructor
// above remain here as independently matched bulk-TU members.
...
DefaultModule<0> *ConcreteModuleTemplate<DefaultModuleTag<0> >::createModule(TrackingPtr<ParticleSystem> &sys)
{
    return (DefaultModule<0> *)new DefaultModule0Allocation(sys, this);
}
...
DefaultModule<1> *ConcreteModuleTemplate<DefaultModuleTag<1> >::createModule(TrackingPtr<ParticleSystem> &sys)
{
    return (DefaultModule<1> *)new DefaultModule1Allocation(sys, this);
}
...
DefaultModule<2> *ConcreteModuleTemplate<DefaultModuleTag<2> >::createModule(TrackingPtr<ParticleSystem> &sys)
{
    return (DefaultModule<2> *)new DefaultModule2Allocation(sys, this);
}
...
{
    return (DefaultModule<6> *)new DefaultModule6Allocation(sys, this);
}
...
DefaultModule<7> *ConcreteModuleTemplate<DefaultModuleTag<7> >::createModule(TrackingPtr<ParticleSystem> &sys)
{
    return (DefaultModule<7> *)new DefaultModule7Allocation(sys, this);
}
...
ButterflyDrawModule *ConcreteModuleTemplate<ModuleTag<6, BUTTERFLY_DRAW_MODULE_KEY, BUTTERFLY_DRAW_MODULE_NAME, ButterflyDrawModule, ButterflyDrawModuleTemplate, DefaultParticleModule<6>, DefaultParticleModuleTemplate<6> > >::createModule(TrackingPtr<ParticleSystem> &sys)
{
    return (ButterflyDrawModule *)new ButterflyDrawModuleAllocation(sys, this);
}
...
LightningDrawModule *ConcreteModuleTemplate<ModuleTag<6, LIGHTNING_DRAW_MODULE_KEY, LIGHTNING_DRAW_MODULE_NAME, LightningDrawModule, LightningDrawModuleTemplate, DefaultParticleModule<6>, DefaultParticleModuleTemplate<6> > >::createModule(TrackingPtr<ParticleSystem> &sys)
{
    return (LightningDrawModule *)new LightningDrawModuleAllocation(sys, this);
}
...
QuadDrawModule *ConcreteModuleTemplate<ModuleTag<6, QUAD_DRAW_MODULE_KEY, QUAD_DRAW_MODULE_NAME, QuadDrawModule, QuadDrawModuleTemplate, DefaultParticleModule<6>, DefaultParticleModuleTemplate<6> > >::createModule(TrackingPtr<ParticleSystem> &sys)
{
    return (QuadDrawModule *)new QuadDrawModuleAllocation(sys, this);
}
...
RenderObjectDrawModule *ConcreteModuleTemplate<ModuleTag<6, RENDEROBJECT_DRAW_MODULE_KEY, RENDEROBJECT_DRAW_MODULE_NAME, RenderObjectDrawModule, RenderObjectDrawModuleTemplate, DefaultParticleModule<6>, DefaultParticleModuleTemplate<6> > >::createModule(TrackingPtr<ParticleSystem> &sys)
{
    return new DefaultParticleModule<6>(sys, (const void *)this);
}
...
LifeEventModule *ConcreteModuleTemplate<ModuleTag<8, LIFE_EVENT_MODULE_KEY, LIFE_EVENT_MODULE_NAME, LifeEventModule, LifeEventModuleTemplate, ParticleLifeEventModule, ParticleLifeEventModuleTemplate> >::createModule(TrackingPtr<ParticleSystem> &sys)
{
    return (LifeEventModule *)new LifeEventModuleAllocation(sys, this);
}
...
TerrainCollisionModule *ConcreteModuleTemplate<ModuleTag<8, TERRAIN_COLLISION_MODULE_KEY, TERRAIN_COLLISION_MODULE_NAME, TerrainCollisionModule, TerrainCollisionModuleTemplate, ParticleTerrainCollisionModule, ParticleTerrainCollisionModuleTemplate> >::createModule(TrackingPtr<ParticleSystem> &sys)
{
    return (TerrainCollisionModule *)new TerrainCollisionModuleAllocation(sys, this);
}
...
{
    RGBColor rgb;
    rgb.red = ((tint >> 16) & 0xff) / 255.0f;
    rgb.green = ((tint >> 8) & 0xff) / 255.0f;
    rgb.blue = (tint & 0xff) / 255.0f;

    for (int key = 1; key < 8; ++key) {
        m_colorKey[key].red *= rgb.red;
        m_colorKey[key].green *= rgb.green;
        m_colorKey[key].blue *= rgb.blue;
    }
...
void BoxEmissionVolumeModuleTemplate::writeINI(File &file, unsigned int flags) const
{
...
void CylindricalEmissionVelocityModuleTemplate::writeINI(File &file, unsigned int flags) const
{
    typedef _STL::basic_string<char, _STL::char_traits<char>, _STL::allocator<char> > StreamText;
    typedef BfmeNarrowStreamText StreamText;
    typedef void (__cdecl *BaseWriteFunction)(const void *self, File *file, unsigned int *flags);
...
void LightningDrawModuleTemplate::writeINI(File &file, unsigned int flags) const
{
    typedef _STL::basic_string<char, _STL::char_traits<char>, _STL::allocator<char> > StreamText;
    typedef BfmeNarrowStreamText StreamText;
    typedef void (__cdecl *FinishWriteFunction)(File *file, unsigned int *flags);
...
void LightningEmissionModuleTemplate::writeINI(File &file, unsigned int flags) const
{
    typedef _STL::basic_string<char, _STL::char_traits<char>, _STL::allocator<char> > StreamText;
    typedef BfmeNarrowStreamText StreamText;
    typedef void (__cdecl *BaseWriteFunction)(const void *self, File *file, unsigned int *flags);
...
void LineEmissionVolumeModuleTemplate::writeINI(File &file, unsigned int flags) const
{
    typedef _STL::basic_string<char, _STL::char_traits<char>, _STL::allocator<char> > StreamText;
    typedef BfmeNarrowStreamText StreamText;
    typedef void (__cdecl *BaseWriteFunction)(const void *self, File *file, unsigned int *flags);
...
void OrthoEmissionVelocityModuleTemplate::writeINI(File &file, unsigned int flags) const
{
    typedef _STL::basic_string<char, _STL::char_traits<char>, _STL::allocator<char> > StreamText;
    typedef BfmeNarrowStreamText StreamText;
    typedef void (__cdecl *BaseWriteFunction)(const void *self, File *file, unsigned int *flags);
...
void OutwardEmissionVelocityModuleTemplate::writeINI(File &file, unsigned int flags) const
{
    typedef _STL::basic_string<char, _STL::char_traits<char>, _STL::allocator<char> > StreamText;
    typedef BfmeNarrowStreamText StreamText;
    typedef void (__cdecl *BaseWriteFunction)(const void *self, File *file, unsigned int *flags);
...
void PointEmissionVolumeModuleTemplate::writeINI(File &file, unsigned int flags) const
{
    typedef _STL::basic_string<char, _STL::char_traits<char>, _STL::allocator<char> > StreamText;
    typedef BfmeNarrowStreamText StreamText;
    typedef void (__cdecl *BaseWriteFunction)(const void *self, File *file, unsigned int *flags);
...
void RenderObjectUpdateModuleTemplate::writeINI(File &file, unsigned int flags) const
{
    typedef _STL::basic_string<char, _STL::char_traits<char>, _STL::allocator<char> > StreamText;
    typedef BfmeNarrowStreamText StreamText;
    typedef void (__cdecl *BaseWriteFunction)(const void *self, File *file, unsigned int *flags);
...
void SphereEmissionVolumeModuleTemplate::writeINI(File &file, unsigned int flags) const
{
    typedef _STL::basic_string<char, _STL::char_traits<char>, _STL::allocator<char> > StreamText;
    typedef BfmeNarrowStreamText StreamText;
    typedef void (__cdecl *BaseWriteFunction)(const void *self, File *file, unsigned int *flags);
...
void SphericalEmissionVelocityModuleTemplate::writeINI(File &file, unsigned int flags) const
{
    typedef _STL::basic_string<char, _STL::char_traits<char>, _STL::allocator<char> > StreamText;
    typedef BfmeNarrowStreamText StreamText;
    typedef void (__cdecl *BaseWriteFunction)(const void *self, File *file, unsigned int *flags);
...
void TerrainCollisionModuleTemplate::writeINI(File &file, unsigned int flags) const
{
    typedef _STL::basic_string<char, _STL::char_traits<char>, _STL::allocator<char> > StreamText;
    typedef BfmeNarrowStreamText StreamText;
    typedef void (__cdecl *BaseWriteFunction)(const void *self, File *file, unsigned int *flags);
