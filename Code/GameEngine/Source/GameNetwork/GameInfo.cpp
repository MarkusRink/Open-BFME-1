...
// ?isSandbox@GameInfo@@QAE_NXZ matched 843 bytes (Open-BFME5)
__declspec(naked) Bool GameInfo::isSandbox(void)
{
	__asm
	{
		__emit 0x6a;
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@SkirmishGameInfo@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@SkirmishGameInfo@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@SkirmishGameInfo@@MAEXXZ present-unmatched
