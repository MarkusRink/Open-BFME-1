...
// stlport
// NAMED_USE_COMMANDBUTTON_ON_NEAREST_GARRISONED_BUILDING at retail RVA
// 0x002FA2D0. The action template at index 425 names this handler.
...
{
protected:
	void doNamedUseCommandButtonOnNearestGarrisonedBuilding(
		const AsciiString &unitName, const AsciiString &commandAbility);
};

// ?doNamedUseCommandButtonOnNearestGarrisonedBuilding@ScriptActions@@IAEXABVAsciiString@@0@Z
void ScriptActions::doNamedUseCommandButtonOnNearestGarrisonedBuilding(
	const AsciiString &unitName, const AsciiString &commandAbility)
{
	...
	Object *target = 0;
	{
		...
		PartitionFilterGarrisonable garrisonableFilter(true);
