...
//----------------------------------------------------------------------------------------------------------
// ?clear@TurretStateMachine@@UAEXXZ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@TurretStateMachine@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@TurretStateMachine@@MAEXPAVXfer@@@Z present-unmatched
...
//----------------------------------------------------------------------------------------------------------
// ?buildFieldParse@TurretAIData@@ present-unmatched
...
//----------------------------------------------------------------------------------------------------------
// ??1TurretAI@@MAE@XZ present-unmatched
TurretAI::~TurretAI()
{
	stopRotOrPitchSound();
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@TurretAI@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@TurretAI@@MAEXPAVXfer@@@Z present-unmatched
...
//----------------------------------------------------------------------------------------------------------
// ?isWeaponSlotOkToFire@TurretAI@@UBE_NW4WeaponSlotType@@@Z present-unmatched
...
//----------------------------------------------------------------------------------------------------------
// ?friend_getTurretTarget@TurretAI@@QBE?AW4TurretTargetType@@AAPAVObject@@AAUCoord3D@@_N@Z present-unmatched
...
//----------------------------------------------------------------------------------------------------------
// ?removeSelfAsTargeter@TurretAI@@AAEXXZ present-unmatched
...
//----------------------------------------------------------------------------------------------------------
// ?friend_notifyStateMachineChanged@TurretAI@@QAEXXZ present-unmatched
 ...
 */
// ?stopRotOrPitchSound@TurretAI@@AAEXXZ present-unmatched
...
#ifdef INTER_TURRET_DELAY
//----------------------------------------------------------------------------------------------------------
// ?getOtherTurretWeaponInfo@TurretAI@@ present-unmatched
...
//----------------------------------------------------------------------------------------------------------
// ?friend_isAnyWeaponInRangeOf@TurretAI@@QBE_NPBVObject@@@Z present-unmatched
...
#ifdef INTER_TURRET_DELAY
//----------------------------------------------------------------------------------------------------------
// ?friend_getInterTurretDelay@TurretAI@@ present-unmatched
 ...
 */
// ?update@TurretAIAimTurretState@@UAE?AW4StateReturnType@@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?onExit@TurretAIAimTurretState@@UAEXW4StateExitType@@@Z present-unmatched
 ...
 * Stop rotation sound
 */
// ?onExit@TurretAIRecenterTurretState@@UAEXW4StateExitType@@@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@TurretAIIdleState@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@TurretAIIdleState@@MAEXPAVXfer@@@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@TurretAIIdleScanState@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@TurretAIIdleScanState@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@TurretAIIdleScanState@@MAEXXZ present-unmatched
void TurretAIIdleScanState::loadPostProcess( void )
{
}  // end loadPostProcess

//----------------------------------------------------------------------------------------------------------
// ?onEnter@TurretAIIdleScanState@@UAE?AW4StateReturnType@@XZ present-unmatched
 ...
 * Stop rotation sound
 */
// ?onExit@TurretAIIdleScanState@@UAEXW4StateExitType@@@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@TurretAIHoldTurretState@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@TurretAIHoldTurretState@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@TurretAIHoldTurretState@@MAEXXZ present-unmatched
void TurretAIHoldTurretState::loadPostProcess( void )
{
}  // end loadPostProcess

//----------------------------------------------------------------------------------------------------------
// ?onEnter@TurretAIHoldTurretState@@UAE?AW4StateReturnType@@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?onExit@TurretAIHoldTurretState@@UAEXW4StateExitType@@@Z present-unmatched
...
// ?update@TurretAIHoldTurretState@@UAE?AW4StateReturnType@@XZ present-unmatched
