...
class HordeWorkerAIUpdateModuleData : public ModuleData
{
public:
	HordeWorkerAIUpdateModuleData();
	virtual ~HordeWorkerAIUpdateModuleData();
...
// ??0HordeWorkerAIUpdateModuleData@@QAE@XZ
HordeWorkerAIUpdateModuleData::HordeWorkerAIUpdateModuleData()
{
	for (int i = 0; i < 2; ++i)
		m_owned[i] = 0;
	m_unknown20 = 0;
