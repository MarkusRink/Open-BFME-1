...
class DamageModuleModuleData : public ModuleData
{
public:
	DamageModuleModuleData();
	virtual ~DamageModuleModuleData();
...
// ??0DamageModuleModuleData@@QAE@XZ
DamageModuleModuleData::DamageModuleModuleData()
{
	for (int i = 0; i < 2; ++i)
		m_owned[i] = 0;
	m_unknown20 = 0;
