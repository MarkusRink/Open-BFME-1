...
class AIUpdateInterfaceModuleData : public ModuleData
{
public:
	AIUpdateInterfaceModuleData();
	virtual ~AIUpdateInterfaceModuleData();
...
// ??0AIUpdateInterfaceModuleData@@QAE@XZ
AIUpdateInterfaceModuleData::AIUpdateInterfaceModuleData()
{
	for (int i = 0; i < 2; ++i)
		m_owned[i] = 0;
	m_unknown20 = 0;
