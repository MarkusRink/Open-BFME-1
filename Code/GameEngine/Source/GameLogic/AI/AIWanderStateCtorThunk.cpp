...
extern int g_AIWanderStateVTable;
...
class AIWanderState : public AIInternalMoveToState
{
public:
	AIWanderState(StateMachine *machine);
...
AIWanderState::AIWanderState(StateMachine *machine) :
	AIInternalMoveToState(machine, "AIFollowWaypointPathState")
{
	...
	m_vftable = &g_AIWanderStateVTable;
}
