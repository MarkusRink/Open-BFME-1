...
//-------------------------------------------------------------------------------------------------
// ?makeStateMachine@HackInternetAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??0HackInternetAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??1HackInternetAIUpdate@@ present-unmatched
HackInternetAIUpdate::~HackInternetAIUpdate( void )
{
} 

//-------------------------------------------------------------------------------------------------
// ?isIdle@HackInternetAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isHacking@HackInternetAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isHackingPackingOrUnpacking@HackInternetAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?update@HackInternetAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?aiDoCommand@HackInternetAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?hackInternet@HackInternetAIUpdate@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?getUnpackTime@HackInternetAIUpdate@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?getPackTime@HackInternetAIUpdate@@ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?getCashUpdateDelay@HackInternetAIUpdate@@ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@HackInternetAIUpdate@@ present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@HackInternetAIUpdate@@ present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@HackInternetAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??0HackInternetStateMachine@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??1HackInternetStateMachine@@ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@UnpackingState@@ present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@UnpackingState@@ present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@UnpackingState@@ present-unmatched
void UnpackingState::loadPostProcess( void )
{
}  // end loadPostProcess

//-------------------------------------------------------------------------------------------------
// ?onEnter@UnpackingState@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?update@UnpackingState@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?onExit@UnpackingState@@ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@PackingState@@ present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@PackingState@@ present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@PackingState@@ present-unmatched
void PackingState::loadPostProcess( void )
{
}  // end loadPostProcess

//-------------------------------------------------------------------------------------------------
// ?onEnter@PackingState@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?update@PackingState@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?onExit@PackingState@@ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@HackInternetState@@ present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@HackInternetState@@ present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@HackInternetState@@ present-unmatched
void HackInternetState::loadPostProcess( void )
{
}  // end loadPostProcess

//-------------------------------------------------------------------------------------------------
// ?onEnter@HackInternetState@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?update@HackInternetState@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?onExit@HackInternetState@@ present-unmatched
