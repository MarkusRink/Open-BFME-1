...
// retail also uses. Same TU-scoped override WorkerAIUpdate.cpp already carries.
...
//-------------------------------------------------------------------------------------------------
// ??0ChinookAIStateMachine@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??1ChinookAIStateMachine@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??0ChinookAIUpdateModuleData@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?makeStateMachine@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??0ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ??1ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setAirfieldForHealing@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isIdle@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isCurrentlyFerryingSupplies@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isAvailableForSupplying@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isAllowedToAdjustDestination@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getBuildingToNotPathAround@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getAiFreeToExit@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?chooseLocomotorSet@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?update@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setMyState@ChinookAIUpdate@@ present-unmatched
 ...
 */
// ?privateGetRepaired@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?privateCombatDrop@ChinookAIUpdate@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?aiDoCommand@ChinookAIUpdate@@ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@ChinookAIUpdate@@ present-unmatched
...
/** Xfer method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@ChinookAIUpdate@@ present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@ChinookAIUpdate@@ present-unmatched
 ...
 * Attack given object
 */
// ?privateAttackObject@ChinookAIUpdate@@ present-unmatched
 ...
 * Attack given object
 */
// ?privateForceAttackObject@ChinookAIUpdate@@ present-unmatched
 ...
 */
// ?privateAttackPosition@ChinookAIUpdate@@ present-unmatched
...
//------------------------------------------------------------------------------------------------
// ?getUpgradedSupplyBoost@ChinookAIUpdate@@ present-unmatched
