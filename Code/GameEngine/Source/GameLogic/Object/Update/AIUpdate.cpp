...
//-------------------------------------------------------------------------------------------------
// ??0AIUpdateModuleData@@ present-unmatched
...
//=============================================================================
// ?getTurretTargetObject@AIUpdateInterface@@ present-unmatched
...
//=============================================================================
// ?isTurretEnabled@AIUpdateInterface@@ present-unmatched
...
//=============================================================================
// ?getTurretTurnRate@AIUpdateInterface@@ present-unmatched
...
void AIUpdateInterface::destroyPath( void )
{
	...
	retail->m_path = NULL;
	retail->m_waitingForPath = FALSE; // we no longer need it.
	retail->m_isBlockedAndStuck = FALSE;
