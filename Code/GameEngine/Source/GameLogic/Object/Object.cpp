...
//-------------------------------------------------------------------------------------------------
// ?initObject@Object@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ??1Object@@MAE@XZ present-unmatched
Object::~Object()
{
...
//-------------------------------------------------------------------------------------------------
// ?onDestroy@Object@@QAEXXZ present-unmatched
...
//=============================================================================
//=============================================================================
// ?setTeam@Object@@QAEXPAVTeam@@@Z present-unmatched
...
//=============================================================================
//=============================================================================
// ?setOrRestoreTeam@Object@@IAEXPAVTeam@@_N@Z present-unmatched
...
// ?checkAndDetonateBoobyTrap@Object@@ present-unmatched
...
//=============================================================================
// ?setArmorSetFlag@Object@@QAEXW4ArmorSetType@@@Z present-unmatched
...
//=============================================================================
// ?clearArmorSetFlag@Object@@QAEXW4ArmorSetType@@@Z present-unmatched
...
//=============================================================================
// ?testArmorSetFlag@Object@@QBE_NW4ArmorSetType@@@Z present-unmatched
...
//=============================================================================
// ?isOutOfAmmo@Object@@QBE_NXZ present-unmatched
...
//=============================================================================
// ?hasAnyDamageWeapon@Object@@QBE_NXZ present-unmatched
...
//=============================================================================
// ?getMostPercentReadyToFireAnyWeapon@Object@@QBEIXZ present-unmatched
...
//=============================================================================
// ?hasWeaponToDealDamageType@Object@@QBE_NW4DamageType@@@Z present-unmatched
...
//=============================================================================
// ?clearAndSetModelConditionState@Object@@QAEXW4ModelConditionFlagType@@0@Z present-unmatched
...
//=============================================================================
// ?setSpecialModelConditionState@Object@@QAEXW4ModelConditionFlagType@@I@Z present-unmatched
...
//=============================================================================
// ?clearSpecialModelConditionStates@Object@@QAEXXZ present-unmatched
...
// ?getAbleToUseWeaponAgainstTarget@Object@@QBE?AW4CanAttackResult@@W4AbleToAttackType@@PBV1@PBUCoord3D@@W4CommandSourceType@@W4WeaponSlotType@@@Z present-unmatched
...
//=============================================================================
// ?fireCurrentWeapon@Object@@ present-unmatched
...
//==============================================================================
// ?notifyFiringTrackerShotFired@Object@@QAEXPBVWeapon@@W4ObjectID@@@Z present-unmatched
...
//=============================================================================
// ?preFireCurrentWeapon@Object@@QAEXPBV1@@Z present-unmatched
...
// ============================================================================
// ?getLastShotFiredFrame@Object@@QBEIXZ present-unmatched
...
// ============================================================================
// ?getLastVictimID@Object@@QBE?AW4ObjectID@@XZ present-unmatched
...
// ?attemptHealingFromSoleBenefactor@Object@@QAE_NMPBV1@I@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?estimateDamage@Object@@QBEMAAVDamageInfoInput@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?healCompletely@Object@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isStructure@Object@@QBE_NXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isHero@Object@@QBE_NXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?prependToList@Object@@QAEXPAPAV1@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?removeFromList@Object@@QAEXPAPAV1@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?friend_prepareForMapBoundaryAdjust@Object@@QAEXXZ present-unmatched
 ...
 */
// ?isMobile@Object@@QBE_NXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?scoreTheKill@Object@@QAEXPBV1@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getVeterancyLevel@Object@@QBE?AW4VeterancyLevel@@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isSelectable@Object@@QBE_NXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setWeaponSetFlag@Object@@QAEXW4WeaponSetType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?clearWeaponSetFlag@Object@@QAEXW4WeaponSetType@@@Z present-unmatched
...
// ?getHealthBoxPosition@Object@@QBEXAAUCoord3D@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?crc@Object@@MAEXPAVXfer@@@Z present-unmatched
...
/** Object xfer implemtation
	...
	*/
//-------------------------------------------------------------------------------------------------
// ?xfer@Object@@MAEXPAVXfer@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?loadPostProcess@Object@@MAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setWeaponBonusCondition@Object@@QAEXW4WeaponBonusConditionType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?clearWeaponBonusCondition@Object@@QAEXW4WeaponBonusConditionType@@@Z present-unmatched
...
// ?onPartitionCellChange@Object@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?handlePartitionCellMaintenance@Object@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?handleShroud@Object@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?handleValueMap@Object@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?handleThreatMap@Object@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?addValue@Object@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?removeValue@Object@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?addThreat@Object@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?removeThreat@Object@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?look@Object@@IAEXXZ present-unmatched
void Object::look()
{
...
//-------------------------------------------------------------------------------------------------
// ?unlook@Object@@IAEXXZ present-unmatched
void Object::unlook()
{
	if( m_partitionLastLook->isInvalid() )
	{
...
//-------------------------------------------------------------------------------------------------
// ?shroud@Object@@IAEXXZ present-unmatched
void Object::shroud()
{
...
//-------------------------------------------------------------------------------------------------
// ?unshroud@Object@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getShroudRange@Object@@QBEMXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setVisionSpied@Object@@QAEX_NH@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?doStatusDamage@Object@@QAEXW4ObjectStatusTypes@@M@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?doTempWeaponBonus@Object@@QAEXW4WeaponBonusConditionType@@I@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?notifySubdualDamage@Object@@QAEXM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?doCommandButton@Object@@QAEXPBVCommandButton@@W4CommandSourceType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?doCommandButtonAtObject@Object@@QAEXPBVCommandButton@@PAV1@W4CommandSourceType@@@Z present-unmatched
...
/** Execute command button ability directed at a location */
//-------------------------------------------------------------------------------------------------
// ?doCommandButtonUsingWaypoints@Object@@QAEXPBVCommandButton@@PBVWaypoint@@W4CommandSourceType@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?clearLeechRangeModeForAllWeapons@Object@@QAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?findAnyShortcutSpecialPowerModuleInterface@Object@@QBEPAVSpecialPowerModuleInterface@@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?findSpecialPowerWithOverridableDestination@Object@@QBEPAVSpecialPowerUpdateInterface@@W4SpecialPowerType@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?getNumConsecutiveShotsFiredAtTarget@Object@@QBEHPBV1@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?getMultiLogicalBonePosition@Object@@QBEHPBDHPAUCoord3D@@PAVMatrix3D@@_N@Z present-unmatched
...
//=============================================================================
// ?canProduceUpgrade@Object@@QAE_NPBVUpgradeTemplate@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getCarrierDeckHeight@Object@@QBEMXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?reportMissileForCountermeasures@Object@@QAEXPAV1@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?calculateCountermeasureToDivertTo@Object@@QAE?AW4ObjectID@@ABV1@@Z present-unmatched
