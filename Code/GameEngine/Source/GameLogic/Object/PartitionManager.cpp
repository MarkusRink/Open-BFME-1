...
// ??1PartitionContactListNode@@MAE@XZ present-unmatched
...
//-----------------------------------------------------------------------------
// ??0CellAndObjectIntersection@@QAE@XZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?friend_addToCellList@CellAndObjectIntersection@@QAEXPAPAV1@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?friend_removeFromCellList@CellAndObjectIntersection@@QAEXPAPAV1@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?addCoverage@CellAndObjectIntersection@@QAEXPAVPartitionCell@@PAVPartitionData@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?removeAllCoverage@CellAndObjectIntersection@@QAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ??0PartitionCell@@QAE@XZ present-unmatched
...
//-----------------------------------------------------------------------------
// ??1PartitionCell@@QAE@XZ present-unmatched
PartitionCell::~PartitionCell()
{
...
//-----------------------------------------------------------------------------
// ?invalidateShroudedStatusForAllCois@PartitionCell@@QAEXH@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?addLooker@PartitionCell@@QAEXH@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?removeLooker@PartitionCell@@QAEXH@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?addShrouder@PartitionCell@@QAEXH@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?removeShrouder@PartitionCell@@QAEXH@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?getShroudStatusForPlayer@PartitionCell@@QBE?AW4CellShroudStatus@@H@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?getThreatValue@PartitionCell@@QAEIH@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?addThreatValue@PartitionCell@@QAEXHI@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?removeThreatValue@PartitionCell@@QAEXHI@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?getCashValue@PartitionCell@@QAEIH@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?addCashValue@PartitionCell@@QAEXHI@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?removeCashValue@PartitionCell@@QAEXHI@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?friend_addToCellList@PartitionCell@@QAEXPAVCellAndObjectIntersection@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?friend_removeFromCellList@PartitionCell@@QAEXPAVCellAndObjectIntersection@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?getCellCenterPos@PartitionCell@@QAEXAAM0@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@PartitionCell@@UAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method */
// ------------------------------------------------------------------------------------------------
// ?xfer@PartitionCell@@UAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@PartitionCell@@UAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ??0PartitionData@@QAE@XZ present-unmatched
...
//-----------------------------------------------------------------------------
// ??1PartitionData@@MAE@XZ present-unmatched
PartitionData::~PartitionData()
{
...
//-----------------------------------------------------------------------------
// ?getControllingPlayerIndex@PartitionData@@QBEHXZ present-unmatched
...
// ?friend_setShroudednessPrevious@PartitionData@@QAEXHW4ObjectShroudStatus@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?removeAllTouchedCells@PartitionData@@AAEXXZ present-unmatched
...
// -----------------------------------------------------------------------------
// ?addSubPixToCoverage@PartitionData@@AAEXPAVPartitionCell@@@Z present-unmatched
...
// -----------------------------------------------------------------------------
// ?doRectFill@PartitionData@@AAEXMMMMM@Z present-unmatched
...
// -----------------------------------------------------------------------------
// ?hLineCircle@PartitionData@@AAEXHHH@Z present-unmatched
...
// -----------------------------------------------------------------------------
// ?doCircleFill@PartitionData@@AAEXMMM@Z present-unmatched
...
// -----------------------------------------------------------------------------
// ?doSmallFill@PartitionData@@AAEXMMM@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?addPossibleCollisions@PartitionData@@QAEXPAVPartitionContactList@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?collidesWith@PartitionData@@ABE_NPBV1@PAUCollideLocAndNormal@@@Z present-unmatched
...
// ?geomCollidesWithGeom@PartitionManager@@QBE_NPBUCoord3D@@ABVGeometryInfo@@M01M@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?invalidateShroudedStatusForAllPlayers@PartitionData@@QAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?calcMaxCoiForShape@PartitionData@@AAEHW4GeometryType@@MM_N@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?calcMaxCoiForObject@PartitionData@@AAEHXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?makeDirty@PartitionData@@QAEX_N@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allocCoiArray@PartitionData@@AAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?freeCoiArray@PartitionData@@AAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?attachToObject@PartitionData@@QAEXPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?detachFromObject@PartitionData@@QAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?attachToGhostObject@PartitionData@@QAEXPAVGhostObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?detachFromGhostObject@PartitionData@@QAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?addToContactList@PartitionContactList@@QAEXPAVPartitionData@@0@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?removeSpecificPartitionData@PartitionContactList@@QAEXPAVPartitionData@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?resetContactList@PartitionContactList@@QAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?processContactList@PartitionContactList@@QAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ??0PartitionManager@@QAE@XZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?init@PartitionManager@@UAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?reset@PartitionManager@@UAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?shutdown@PartitionManager@@IAEXXZ present-unmatched
...
// ?update@PartitionManager@@UAEXXZ present-unmatched
...
//------------------------------------------------------------------------------
// ?registerObject@PartitionManager@@QAEXPAVObject@@@Z present-unmatched
...
//------------------------------------------------------------------------------
// ?unRegisterObject@PartitionManager@@QAEXPAVObject@@@Z present-unmatched
...
//------------------------------------------------------------------------------
// ?registerGhostObject@PartitionManager@@QAEXPAVGhostObject@@@Z present-unmatched
...
//------------------------------------------------------------------------------
// ?unRegisterGhostObject@PartitionManager@@QAEXPAVGhostObject@@@Z present-unmatched
...
/** 
	...
	*/
// ?revealMapForPlayerPermanently@PartitionManager@@QAEXH@Z present-unmatched
...
/** 
	...
	*/
// ?undoRevealMapForPlayerPermanently@PartitionManager@@QAEXH@Z present-unmatched
...
/** 
	...
	*/
// ?shroudMapForPlayer@PartitionManager@@QAEXH@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?refreshShroudForLocalPlayer@PartitionManager@@QAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?getPropShroudStatusForPlayer@PartitionManager@@QBE?AW4ObjectShroudStatus@@HPBUCoord3D@@@Z present-unmatched
...
#ifdef FASTER_GCO
//-----------------------------------------------------------------------------
// ?calcMinRadius@PartitionManager@@IAEHABUICoord2D@@@Z present-unmatched
...
#ifdef FASTER_GCO
//-----------------------------------------------------------------------------
// ?calcRadiusVec@PartitionManager@@IAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?getRelativeAngle2D@PartitionManager@@ present-unmatched
...
//-----------------------------------------------------------------------------
// ?iteratePotentialCollisions@PartitionManager@@QAEPAVSimpleObjectIterator@@PBUCoord3D@@ABVGeometryInfo@@M_N@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?isColliding@PartitionManager@@QBE_NPBVObject@@0@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?iterateAllObjects@PartitionManager@@QAEPAVSimpleObjectIterator@@PAPAVPartitionFilter@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?tryPosition@PartitionManager@@IAE_NPBUCoord3D@@MMPBUFindPositionOptions@@PAU2@@Z present-unmatched
...
/** This method will attempt to find a legal postion from the center position specified,
	...
	*/
//-------------------------------------------------------------------------------------------------
// ?findPositionAround@PartitionManager@@QAE_NPBUCoord3D@@PBUFindPositionOptions@@PAU2@@Z present-unmatched
...
// ?doShroudReveal@PartitionManager@@QAEXMMMG@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?processPendingUndoShroudRevealQueue@PartitionManager@@IAEX_N@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?processEntirePendingUndoShroudRevealQueue@PartitionManager@@QAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?resetPendingUndoShroudRevealQueue@PartitionManager@@IAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?undoShroudReveal@PartitionManager@@QAEXMMMG@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?queueUndoShroudReveal@PartitionManager@@QAEXMMMG@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?doShroudCover@PartitionManager@@QAEXMMMG@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?undoShroudCover@PartitionManager@@QAEXMMMG@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?doThreatAffect@PartitionManager@@QAEXMMMIG@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?undoThreatAffect@PartitionManager@@QAEXMMMIG@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?doValueAffect@PartitionManager@@QAEXMMMIG@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?undoValueAffect@PartitionManager@@QAEXMMMIG@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?getCellCenterPos@PartitionManager@@QAEXHHAAM0@Z present-unmatched
...
//-----------------------------------------------------------------------------
#ifdef PM_CACHE_TERRAIN_HEIGHT
// ?estimateTerrainExtremesAlongLine@PartitionManager@@QAE_NABUCoord3D@@0PAM1PAUCoord2D@@2@Z present-unmatched
...
// ?iterateCellsAlongLine@PartitionManager@@IAEHABUCoord3D@@0P6AHPAVPartitionCell@@PAX@Z2@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?iterateCellsBreadthFirst@PartitionManager@@IAEHPBUCoord3D@@P6AHPAVPartitionCell@@PAX@Z2@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?isClearLineOfSightTerrain@PartitionManager@@QAE_NPBVObject@@ABUCoord3D@@01@Z present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@PartitionManager@@UAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method
	...
	*/
// ------------------------------------------------------------------------------------------------
// ?xfer@PartitionManager@@UAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@PartitionManager@@UAEXXZ present-unmatched
...
//-----------------------------------------------------------------------------
// ?getGroundOrStructureHeight@PartitionManager@@QAEMMM@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?storeFoggedCells@PartitionManager@@QBEXAAUShroudStatusStoreRestore@@_N@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?restoreFoggedCells@PartitionManager@@QAEXABUShroudStatusStoreRestore@@_N@Z present-unmatched
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterFreeOfFog@@MAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterInsignificantBuildings@@MAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterGarrisonableByPlayer@@MAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterUnmannedObject@@MAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterValidCommandButtonTarget@@MAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterIsFlying@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ??0PartitionFilterWouldCollide@@QAE@ABUCoord3D@@ABVGeometryInfo@@M_N@Z present-unmatched
...
// ?allow@PartitionFilterWouldCollide@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterSamePlayer@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterAcceptOnTeam@@UAE_NPAVObject@@@Z present-unmatched
...
// ?allow@PartitionFilterAcceptOnSquad@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterSameMapStatus@@MAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterOnMap@@MAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterAlive@@MAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterLineOfSight@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterPossibleToAttack@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterPossibleToEnter@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterPossibleToHijack@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ??0PartitionFilterLastAttackedBy@@QAE@PAVObject@@@Z present-unmatched
...
// ?allow@PartitionFilterLastAttackedBy@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterAcceptByObjectStatus@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterRejectByObjectStatus@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterAcceptByKindOf@@UAE_NPAVObject@@@Z present-unmatched
...
//-----------------------------------------------------------------------------
// ?allow@PartitionFilterStealthedAndUndetected@@UAE_NPAVObject@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ??0SightingInfo@@QAE@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?reset@SightingInfo@@QAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?isInvalid@SightingInfo@@QBE_NXZ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@SightingInfo@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer Method
	...
	* 1: Initial version */
// ------------------------------------------------------------------------------------------------
// ?xfer@SightingInfo@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@SightingInfo@@MAEXXZ present-unmatched
