...
// ------------------------------------------------------------------------------------------------
// ??0GameLogic@@QAE@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?setDefaults@GameLogic@@AAEX_N@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?destroyAllObjectsImmediate@GameLogic@@AAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?deleteLoadScreen@GameLogic@@QAEXXZ matched 1473 bytes (Open-BFME5)
__declspec(naked) void GameLogic::deleteLoadScreen(void)
{
	__asm
	{
		__emit 0x6a;
...
//-------------------------------------------------------------------------------------------------
// ?processCommandList@GameLogic@@QAEXPAVCommandList@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?isIntroMoviePlaying@GameLogic@@QAE_NXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?eraseSleepyUpdate@GameLogic@@AAEXH@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?rebalanceParentSleepyUpdate@GameLogic@@AAEHH@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?rebalanceChildSleepyUpdate@GameLogic@@AAEHH@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?rebalanceSleepyUpdate@GameLogic@@AAEXH@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?remakeSleepyUpdate@GameLogic@@AAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?pushSleepyUpdate@GameLogic@@AAEXPAVUpdateModule@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?peekSleepyUpdate@GameLogic@@ABEPAVUpdateModule@@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?getFirstObject@GameLogic@@QAEPAVObject@@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?allocateObjectID@GameLogic@@QAE?AW4ObjectID@@XZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?registerObject@GameLogic@@QAEXPAVObject@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?friend_createObject@GameLogic@@QAEPAVObject@@PBVThingTemplate@@ABV?$BitFlags@$0CN@@@PAVTeam@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?setGamePaused@GameLogic@@QAEX_N0@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?isProgressComplete@GameLogic@@QAE_NXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?lastHeardFrom@GameLogic@@AAEXH@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?testTimeOut@GameLogic@@AAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?timeOutGameStart@GameLogic@@QAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?getObjectCount@GameLogic@@QAEIXZ present-unmatched
...
#ifdef DUMP_PERF_STATS
// ------------------------------------------------------------------------------------------------
// ?getAIMetricsStatistics@GameLogic@@ present-unmatched
...
/** Light CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@GameLogic@@MAEXPAVXfer@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?findTOCEntryByName@GameLogic@@AAEPAUObjectTOCEntry@1@VAsciiString@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?findTOCEntryById@GameLogic@@AAEPAUObjectTOCEntry@1@G@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?addTOCEntry@GameLogic@@AAEXVAsciiString@@G@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?xferObjectTOC@GameLogic@@AAEXPAVXfer@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// ?prepareLogicForObjectLoad@GameLogic@@AAEXXZ present-unmatched
...
/** Load/Save game logic to xfer 
  ...
  * 10: xfer m_superweaponRestriction
	*/	
// ------------------------------------------------------------------------------------------------
// ?xfer@GameLogic@@MAEXPAVXfer@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@GameLogic@@MAEXXZ present-unmatched
