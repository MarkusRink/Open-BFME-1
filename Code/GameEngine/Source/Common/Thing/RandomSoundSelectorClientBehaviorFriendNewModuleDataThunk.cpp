...
extern "C" void __cdecl RandomSoundSelectorClientBehaviorFieldParse(MultiIniFieldParse &parse);
...
ModuleData *RandomSoundSelectorClientBehavior::friend_newModuleData(INI *ini)
{
	...
	if (ini)
		ini->initFromINIMultiProc(data, &RandomSoundSelectorClientBehaviorFieldParse);
