...
{
public:
	void bfmeRotateZTX(float theta);
...
void BfmeMtxTX::bfmeRotateZTX(float theta)
{
	...
	tmp2 = m_bfmeRowTX[0][1];
	m_bfmeRowTX[0][0] = c * tmp1 + s * tmp2;
	m_bfmeRowTX[0][1] = c * tmp2 - s * tmp1;

	tmp1 = m_bfmeRowTX[1][0];
	tmp2 = m_bfmeRowTX[1][1];
	m_bfmeRowTX[1][0] = c * tmp1 + s * tmp2;
	m_bfmeRowTX[1][1] = c * tmp2 - s * tmp1;

	tmp1 = m_bfmeRowTX[2][0];
	tmp2 = m_bfmeRowTX[2][1];
	m_bfmeRowTX[2][0] = c * tmp1 + s * tmp2;
	m_bfmeRowTX[2][1] = c * tmp2 - s * tmp1;
