...
// stlport
// Split by hand out of Code/gen_small/zhstl_001.cpp; the phase-5 ZH STLport
...
// compiles to `operator new`. reference/shims/stlp_nodealloc fixes that for a
...
// seven per-site pins in reverse/symbols.csv name.
