...
// ?getAnimHandle@W3DAnimationInfo@@QBEPAVHAnimClass@@XZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?preloadAssets@ModelConditionInfo@@QAEXW4TimeOfDay@@M@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?matchesMode@ModelConditionInfo@@QBE_N_N0@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?validateStuff@ModelConditionInfo@@QBEXPAVRenderObjClass@@MABV?$vector@VAsciiString@@V?$allocator@VAsciiString@@@_STL@@@_STL@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?validateCachedBones@ModelConditionInfo@@ABEXPAVRenderObjClass@@M@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?validateWeaponBarrelInfo@ModelConditionInfo@@ABEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?validateTurretInfo@ModelConditionInfo@@ABEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?findPristineBone@ModelConditionInfo@@QBEPBVMatrix3D@@W4NameKeyType@@PAH@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?findPristineBonePos@ModelConditionInfo@@QBE_NW4NameKeyType@@AAUCoord3D@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?loadAnimations@ModelConditionInfo@@QBEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?clear@ModelConditionInfo@@QAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?validateStuffForTimeAndWeather@W3DModelDrawModuleData@@QBEXPBVDrawable@@_N1@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?preloadAssets@W3DModelDrawModuleData@@QBEXW4TimeOfDay@@M@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getBestModelNameForWB@W3DModelDrawModuleData@@QBE?AVAsciiString@@ABV?$BitFlags@$0HF@@@@Z present-unmatched
...
#ifdef CACHE_ATTACH_BONE
//-------------------------------------------------------------------------------------------------
// ?getAttachToDrawableBoneOffset@W3DModelDrawModuleData@@QBEPBVVector3@@PBVDrawable@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?buildFieldParse@W3DModelDrawModuleData@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?showSubObject@W3DModelDraw@@UAEXABVAsciiString@@_N@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ??0W3DModelDraw@@QAE@PAVThing@@PBVModuleData@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?onDrawableBoundToObject@W3DModelDraw@@UAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?doStartOrStopParticleSys@W3DModelDraw@@AAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setHidden@W3DModelDraw@@UAEX_N@Z present-unmatched
...
// ?releaseShadows@W3DModelDraw@@UAEXXZ present-unmatched
...
// ?allocateShadows@W3DModelDraw@@UAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setShadowsEnabled@W3DModelDraw@@UAEX_N@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?adjustAnimSpeedToMovementSpeed@W3DModelDraw@@AAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?adjustTransformMtx@W3DModelDraw@@MBEXAAVMatrix3D@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?doDrawModule@W3DModelDraw@@UAEXPBVMatrix3D@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?findTransitionForSig@W3DModelDraw@@ABEPBUModelConditionInfo@@_K@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getCurrentAnimFraction@W3DModelDraw@@ABEMXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?adjustAnimation@W3DModelDraw@@AAEXPBUModelConditionInfo@@M@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?doHideShowSubObjs@W3DModelDraw@@IAEXPBV?$vector@UHideShowSubObjInfo@ModelConditionInfo@@V?$allocator@UHideShowSubObjInfo@ModelConditionInfo@@@_STL@@@_STL@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?stopClientParticleSystems@W3DModelDraw@@IAEXXZ present-unmatched
...
/*
	...
	DANGER WARNING READ ME
*/
// ?handleClientTurretPositioning@W3DModelDraw@@IAEXXZ present-unmatched
...
*/
// ?handleClientRecoil@W3DModelDraw@@IAEXXZ present-unmatched
...
/*
	...
	DANGER WARNING READ ME
*/
// ?recalcBonesForClientParticleSystems@W3DModelDraw@@IAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setTerrainDecal@W3DModelDraw@@UAEXW4TerrainDecalType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?nukeCurrentRender@W3DModelDraw@@AAEXPAVMatrix3D@@@Z present-unmatched
...
// ?hideAllHeadlights@W3DModelDraw@@AAEX_N@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?hideAllMuzzleFlashes@W3DModelDraw@@CAXPBUModelConditionInfo@@PAVRenderObjClass@@@Z present-unmatched
...
/** Change the model for this drawable. If color is non-zero, it will also apply team color to the
	model */
//-------------------------------------------------------------------------------------------------
// ?setModelState@W3DModelDraw@@IAEXPBUModelConditionInfo@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?replaceModelConditionState@W3DModelDraw@@UAEXABV?$BitFlags@$0HF@@@@Z present-unmatched
...
{
	// ObjectDrawInterface supplies a -0x10 adjusted this; BFME stores this member at effective +0x28.
	if (!*(RenderObjClass * const *)((const char *)this + 0x38))
		return false;

	Vector3 objPos = (*(RenderObjClass * const *)((const char *)this + 0x38))->Get_Position();	//get position of object
	pos->x = objPos.X;
	pos->y = objPos.Y;
	pos->z = objPos.Z;

	*transform = (*(RenderObjClass * const *)((const char *)this + 0x38))->Get_Transform();
	*boundingSphereRadius = (*(RenderObjClass * const *)((const char *)this + 0x38))->Get_Bounding_Sphere().Radius;

	return true;
}

//-------------------------------------------------------------------------------------------------
// ?getProjectileLaunchOffset@W3DModelDraw@@UBE_NABV?$BitFlags@$0HF@@@W4WeaponSlotType@@HPAVMatrix3D@@W4WhichTurretType@@PAUCoord3D@@4@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getPristineBonePositionsForConditionState@W3DModelDraw@@UBEHABV?$BitFlags@$0HF@@@PBDHPAUCoord3D@@PAVMatrix3D@@H@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?getCurrentBonePositions@W3DModelDraw@@UBEHPBDHPAUCoord3D@@PAVMatrix3D@@H@Z matched 1276 bytes (Open-BFME5)
__declspec(naked) Int W3DModelDraw::getCurrentBonePositions(const char *, Int, Coord3D *, Matrix3D *, Int) const
{
	__asm
	{
		__emit 0x6a;
...
//-------------------------------------------------------------------------------------------------
// ?getBarrelCount@W3DModelDraw@@UBEHW4WeaponSlotType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?handleWeaponFireFX@W3DModelDraw@@UAE_NW4WeaponSlotType@@HPBVFXList@@MPBUCoord3D@@M@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setAnimationLoopDuration@W3DModelDraw@@UAEXI@Z present-unmatched
...
*/
// ?setAnimationCompletionTime@W3DModelDraw@@UAEXI@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?setAnimationFrame@W3DModelDraw@@UAEXH@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?preloadAssets@W3DModelDraw@@UAEXW4TimeOfDay@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?isVisible@W3DModelDraw@@UBE_NXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?updateProjectileClipStatus@W3DModelDraw@@UAEXIIW4WeaponSlotType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?updateDrawModuleSupplyStatus@W3DModelDraw@@UAEXHH@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?doHideShowProjectileObjects@W3DModelDraw@@AAEXIIW4WeaponSlotType@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?updateSubObjects@W3DModelDraw@@UAEXXZ present-unmatched
...
/** CRC */
// ------------------------------------------------------------------------------------------------
// ?crc@W3DModelDraw@@MAEXPAVXfer@@@Z present-unmatched
...
/** Xfer method
	...
	*/
// ------------------------------------------------------------------------------------------------
// ?xfer@W3DModelDraw@@MAEXPAVXfer@@@Z present-unmatched
...
/** Load post process */
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@W3DModelDraw@@MAEXXZ present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?crc@W3DModelDrawModuleData@@UAEXPAVXfer@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?xfer@W3DModelDrawModuleData@@UAEXPAVXfer@@@Z present-unmatched
...
// ------------------------------------------------------------------------------------------------
// ?loadPostProcess@W3DModelDrawModuleData@@UAEXXZ present-unmatched
