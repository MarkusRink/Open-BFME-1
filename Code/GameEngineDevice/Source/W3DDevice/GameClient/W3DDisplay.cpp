...
//=============================================================================
// ??0StatDumpClass@@ present-unmatched
...
//=============================================================================
// ??1StatDumpClass@@ present-unmatched
...
// ?dumpStats@StatDumpClass@@ present-unmatched
...
/** */
//=============================================================================
// ??1W3DDisplay@@UAE@XZ present-unmatched
W3DDisplay::~W3DDisplay()
{
...
// ?getDisplayModeCount@W3DDisplay@@UAEHXZ present-unmatched
...
// ?getDisplayModeDescription@W3DDisplay@@UAEXHPAH00@Z present-unmatched
...
/** */
//=============================================================================
// ?initAssets@W3DDisplay@@IAEXXZ present-unmatched
...
/** */
//=============================================================================
// ?init3DScene@W3DDisplay@@IAEXXZ present-unmatched
...
/** This is the 2D scene, you can use it to draw on a 2D plane over the
	* 3D background */
//=============================================================================
// ?init2DScene@W3DDisplay@@IAEXXZ present-unmatched
...
//=============================================================================
// ?init@W3DDisplay@@UAEXXZ present-unmatched
...
// ?Set_Collision_Box_Display_Mask@WW3D@@ present-unmatched
	WW3D::Set_Collision_Box_Display_Mask(0x00);	///<set to 0xff to make collision boxes visible
	WW3D::Enable_Static_Sort_Lists(true);
	WW3D::Set_Thumbnail_Enabled(false);
// ?Set_Screen_UV_Bias@WW3D@@SAX_N@Z present-unmatched
...
//=============================================================================
// ?reset@W3DDisplay@@UAEXXZ present-unmatched
...
//=============================================================================
// ?drawDebugStats@W3DDisplay@@IAEXXZ present-unmatched
...
//=============================================================================
// ?drawFPSStats@W3DDisplay@@QAEXXZ present-unmatched
...
//=============================================================================
// ?calculateTerrainLOD@W3DDisplay@@IAEXXZ present-unmatched
...
// ?getAverageFPS@W3DDisplay@@UAEMXZ present-unmatched
Real W3DDisplay::getAverageFPS()
{
	return m_averageFPS;
}

// ?getLastFrameDrawCalls@W3DDisplay@@UAEHXZ present-unmatched
...
// ?draw@W3DDisplay@@ present-unmatched
...
*/
// ?renderLetterBox@W3DDisplay@@IAEXI@Z present-unmatched
...
/** */
//=============================================================================
// ?setTimeOfDay@W3DDisplay@@UAEXW4TimeOfDay@@@Z present-unmatched
...
//=============================================================================
// ?drawLine@W3DDisplay@@ present-unmatched
...
//=============================================================================
// ?drawOpenRect@W3DDisplay@@UAEXHHHHMI@Z present-unmatched
...
//=============================================================================
// ?drawFillRect@W3DDisplay@@UAEXHHHHI@Z present-unmatched
...
// ?drawRectClock@W3DDisplay@@UAEXHHHHHI@Z present-unmatched
...
//--------------------------------------------------------------------------------------------------------------------
// ?drawRemainingRectClock@W3DDisplay@@UAEXHHHHHI@Z present-unmatched
...
//=============================================================================
// ?drawImage@W3DDisplay@@UAEXPBVImage@@HHHHHW4DrawImageMode@Display@@@Z present-unmatched
...
// ?createVideoBuffer@W3DDisplay@@UAEPAVVideoBuffer@@XZ present-unmatched
...
// ?drawVideoBuffer@W3DDisplay@@UAEXPAVVideoBuffer@@HHHH@Z present-unmatched
...
//=============================================================================
// ?setClipRegion@W3DDisplay@@UAEXPAUIRegion2D@@@Z present-unmatched
...
// ?toggleMovieCapture@W3DDisplay@@UAEXXZ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?dumpModelAssets@W3DDisplay@@ present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?preloadModelAssets@W3DDisplay@@UAEXVAsciiString@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
// ?preloadTextureAssets@W3DDisplay@@UAEXVAsciiString@@@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// ?doSmartAssetPurgeAndPreload@W3DDisplay@@UAEXPBD@Z present-unmatched
...
//-------------------------------------------------------------------------------------------------
#if defined(_DEBUG) || defined(_INTERNAL)
// ?dumpAssetUsage@W3DDisplay@@ present-unmatched
