...
// ??0DX8TextureCategoryClass@@QAE@PAVDX8FVFCategoryContainer@@PAPAVTextureClass@@VShaderClass@@PAVVertexMaterialClass@@H@Z present-unmatched
...
// ??1DX8TextureCategoryClass@@UAE@XZ present-unmatched
DX8TextureCategoryClass::~DX8TextureCategoryClass()
{
...
// ?Log@DX8TextureCategoryClass@@QAEX_N@Z present-unmatched
...
// ?Check_If_Mesh_Fits@DX8RigidFVFCategoryContainer@@UAE_NPAVMeshModelClass@@@Z present-unmatched
...
// ?Insert_To_Texture_Category@DX8FVFCategoryContainer@@IAEXAAVVertex_Split_Table@@PAPAVTextureClass@@PAVVertexMaterialClass@@VShaderClass@@HI@Z present-unmatched
...
// ??0DX8SkinFVFCategoryContainer@@QAE@_N@Z present-unmatched
...
// ??1DX8SkinFVFCategoryContainer@@UAE@XZ present-unmatched
...
// ?Render@DX8SkinFVFCategoryContainer@@UAEXXZ present-unmatched
...
bool DX8SkinFVFCategoryContainer::Check_If_Mesh_Fits(MeshModelClass* mmc)
{
	...
	int required_polygons = *reinterpret_cast<const int *>(
		*reinterpret_cast<const int * const *>(
			reinterpret_cast<const char *>(mmc) + 0x9c));
	int pass_count = *reinterpret_cast<const int *>(
		reinterpret_cast<const char *>(mmc) + 0x24);

	if ((required_polygons*3*pass_count)<=unknown_D8->Get_Index_Count()-unknown_DC) {
		return true;
	}
	return false;
}
...
// ?Add_Mesh@DX8SkinFVFCategoryContainer@@UAEXPAVMeshModelClass@@@Z present-unmatched
...
// ?Add_Mesh@DX8TextureCategoryClass@@QAEIAAVVertex_Split_Table@@IIPAVIndexBufferClass@@I@Z present-unmatched
...
// ?Render@DX8TextureCategoryClass@@QAEXXZ present-unmatched
...
// ??1DX8MeshRendererClass@@QAE@XZ present-unmatched
DX8MeshRendererClass::~DX8MeshRendererClass()
{
	Invalidate(true);
...
// ?Add_To_Render_List@DX8MeshRendererClass@@QAEXPAVDecalMeshClass@@@Z present-unmatched
...
// ?Render_Decal_Meshes@DX8MeshRendererClass@@IAEXXZ present-unmatched
