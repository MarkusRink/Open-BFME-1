 ...
 *   2/16/99    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?read_chunks@MeshModelClass@@IAE?AW4WW3DErrorType@@AAVChunkLoadClass@@PAVMeshLoadContextClass@@@Z present-unmatched
 ...
 *=============================================================================================*/
// ?read_v3_materials@MeshModelClass@@IAE?AW4WW3DErrorType@@AAVChunkLoadClass@@PAVMeshLoadContextClass@@@Z present-unmatched
 ...
 *   4/7/98     GTH : Created.                                                                 *
 *=============================================================================================*/
// ?read_per_tri_materials@MeshModelClass@@IAE?AW4WW3DErrorType@@AAVChunkLoadClass@@PAVMeshLoadContextClass@@@Z present-unmatched
 ...
 *   2/16/99    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?read_material_info@MeshModelClass@@IAE?AW4WW3DErrorType@@AAVChunkLoadClass@@PAVMeshLoadContextClass@@@Z present-unmatched
 ...
 *   2/16/99    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?read_vertex_materials@MeshModelClass@@IAE?AW4WW3DErrorType@@AAVChunkLoadClass@@PAVMeshLoadContextClass@@@Z present-unmatched
 ...
 *=============================================================================================*/
// ?read_textures@MeshModelClass@@IAE?AW4WW3DErrorType@@AAVChunkLoadClass@@PAVMeshLoadContextClass@@@Z present-unmatched
 ...
 *=============================================================================================*/
// BFME read_dcg returns bool; its recovered implementation is in MeshModelVertexColors.cpp.
 ...
 *=============================================================================================*/
// ?read_scg@MeshModelClass@@IAE?AW4WW3DErrorType@@AAVChunkLoadClass@@PAVMeshLoadContextClass@@@Z present-unmatched
 ...
 *   9/1/2000   gth : Added alternate material desc support                                    *
 *=============================================================================================*/
// ?read_per_face_texcoord_ids@MeshModelClass@@IAE?AW4WW3DErrorType@@AAVChunkLoadClass@@PAVMeshLoadContextClass@@@Z present-unmatched
 ...
 *   02/02/99    IML : Created.                                                                *
 *=============================================================================================*/
// ?read_prelit_material@MeshModelClass@@IAE?AW4WW3DErrorType@@AAVChunkLoadClass@@PAVMeshLoadContextClass@@@Z present-unmatched
...
// ?post_process_fog@MeshModelClass@@IAEXXZ matched 929 bytes (Open-BFME5)
__declspec(naked) void MeshModelClass::post_process_fog(void)
{
	__asm
	{
		__emit 0x6a;
 ...
 *   12/10/98   GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Add_Texture@MeshLoadContextClass@@AAEHPAVTextureClass@@@Z present-unmatched
 ...
 *   12/10/98   GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Add_Legacy_Material@MeshLoadContextClass@@AAEXVShaderClass@@PAVVertexMaterialClass@@PAVTextureClass@@@Z present-unmatched
 ...
 *   12/10/98   GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Peek_Legacy_Texture@MeshLoadContextClass@@AAEPAVTextureClass@@H@Z present-unmatched
 ...
 * HISTORY:                                                                                    *
 *=============================================================================================*/
// ??1MeshSaveContextClass@@QAE@XZ present-unmatched
MeshSaveContextClass::~MeshSaveContextClass(void)
{
}
 ...
 *   2/16/99    GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Save_W3D@MeshModelClass@@ present-unmatched
...
// ?write_chunks@MeshModelClass@@ present-unmatched
...
// ?write_header@MeshModelClass@@ present-unmatched
...
// ?write_user_text@MeshModelClass@@ present-unmatched
...
// ?write_triangles@MeshModelClass@@ present-unmatched
...
// ?write_vertices@MeshModelClass@@ present-unmatched
...
// ?write_vertex_normals@MeshModelClass@@ present-unmatched
...
// ?write_vertex_shade_indices@MeshModelClass@@ present-unmatched
...
// ?write_vertex_influences@MeshModelClass@@ present-unmatched
...
// ?write_material_info@MeshModelClass@@ present-unmatched
...
// ?write_shaders@MeshModelClass@@ present-unmatched
...
// ?write_vertex_materials@MeshModelClass@@ present-unmatched
...
// ?write_textures@MeshModelClass@@ present-unmatched
...
// ?write_material_pass@MeshModelClass@@ present-unmatched
...
// ?write_vertex_material_ids@MeshModelClass@@ present-unmatched
...
// ?write_shader_ids@MeshModelClass@@ present-unmatched
...
// ?write_scg@MeshModelClass@@ present-unmatched
...
// ?write_dig@MeshModelClass@@ present-unmatched
...
// ?write_dcg@MeshModelClass@@ present-unmatched
...
// ?write_texture_stage@MeshModelClass@@ present-unmatched
...
// ?write_texture_ids@MeshModelClass@@ present-unmatched
...
// ?write_stage_texcoords@MeshModelClass@@ present-unmatched
