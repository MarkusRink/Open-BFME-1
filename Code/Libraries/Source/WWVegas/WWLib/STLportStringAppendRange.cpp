...
// stlport
//
// Open-BFME: _STL::basic_string<char>::append<const char *>(first, last,
// forward_iterator_tag), retail 0x004A4F80, 313 bytes.  This is the
// forward-iterator member-template specialization named by reloc_names.csv.
