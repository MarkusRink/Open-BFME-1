...
__declspec(naked) Debug &operator<<(Debug &debug, const Region2D &region)
{
    __asm {
        __emit 0x56
        __emit 0x8b
...
__declspec(naked) Debug &operator<<(Debug &debug, const IRegion2D &region)
{
    __asm {
        __emit 0x56
        __emit 0x8b
...
__declspec(naked) Debug &operator<<(Debug &debug, const RealRange &range)
{
    __asm {
        __emit 0x56
        __emit 0x8b
