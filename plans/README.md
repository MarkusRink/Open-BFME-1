...
- `merge_cluster.py --list` fails on the malformed marker in
  `Code/GameEngine/Source/GameClient/System/CampaignConstructor.cpp`.
...
- Do not edit Code/gen_asm or Code/gen_small. Do not mint generated or naked
...
`plans/cleanup-run.md` during execution, including:
...
larger reserve. At twelve hours, leave no unfinished reconstruction in Code/;
